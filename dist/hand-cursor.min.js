...
.hc-root[data-state="error"] .hc-copy { color: ${d.red}; }
...
.hc-cta:hover,
.hc-cta.hc-hover { background: ${d.darkGreen}; }
...
.hc-corner:hover,
.hc-corner.hc-hover { background: ${d.divider}; }
...
.hc-mini-cta:hover,
.hc-mini-cta.hc-hover { background: ${d.darkGreen}; }
...
.hc-debug-row b.is-warn { color: ${d.yellow}; }
