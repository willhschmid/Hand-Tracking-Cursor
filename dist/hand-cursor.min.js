...
.hc-root[data-mini="true"][data-position$="-left"] .hc-panel {
  ...
  border-radius: 0 ${x.card}px ${x.card}px 0;
}

.hc-root[data-mini="true"][data-position$="-right"] .hc-panel {
  right: 0;
  border-radius: ${x.card}px 0 0 ${x.card}px;
}
...
.hc-tab svg {
  display: block;
  width: ${v.iconWidth}px;
  height: ${v.iconHeight}px;
  flex: none;
}
