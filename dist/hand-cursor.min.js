...
.hc-stage {
  ...
  flex: 0 0 auto;
  width: ${c.illoWidth}px;
  height: ${c.illoHeight}px;
  display: flex;
  align-items: center;
...
.hc-copy {
  ...
  max-width: 100%;
  text-align: center;
  font-size: ${b.body.size}px;
  font-weight: ${b.body.weight};
  line-height: ${b.body.leading}px;
...
.hc-cta {
  ...
  justify-content: center;
  gap: ${c.ctaGap}px;
  height: ${c.ctaHeight}px;
  padding: 0 ${c.ctaPadX}px;
  border-radius: ${A.button}px;
  background: ${u.green};
  color: ${u.white};
  font-family: inherit;
  font-size: ${b.label.size}px;
  font-weight: ${b.label.weight};
  line-height: ${b.label.leading}px;
  letter-spacing: -0.01em;
  cursor: pointer;
...
.hc-cta svg { width: ${c.iconSize}px; height: ${c.iconSize}px; flex: none; }
...
.hc-corner {
  width: ${c.cornerButton}px;
  height: ${c.cornerButton}px;
  border-radius: ${A.button}px;
  transition: background-color 150ms linear;
}

.hc-corner svg { width: ${c.iconSize}px; height: ${c.iconSize}px; }
.hc-corner:hover,
.hc-corner.hc-hover { background: ${u.divider}; }

.hc-corner--tr { top: ${c.cornerInset}px; right: ${c.cornerInset}px; display: inline-flex; }
.hc-corner--tl { top: ${c.cornerInset}px; left: ${c.cornerInset}px; }
...
.hc-mini-cta {
  left: ${c.cornerInset}px;
  bottom: ${c.cornerInset}px;
  width: ${c.miniCta}px;
  height: ${c.miniCta}px;
  border-radius: ${A.button}px;
  background: ${u.green};
...
.hc-mini-cta svg { width: ${c.iconSize}px; height: ${c.iconSize}px; }
.hc-mini-cta:hover,
.hc-mini-cta.hc-hover { background: ${u.darkGreen}; }
...
`;var T=r=>`<svg viewBox="0 0 24 24" fill="none" aria-hidden="true" focusable="false"><path d="${r}" fill="currentColor"/></svg>`,y={videocam:T("M4 20C3.45 20 2.97917 19.8042 2.5875 19.4125C2.19583 19.0208 2 18.55 2 18V6C2 5.45 2.19583 4.97917 2.5875 4.5875C2.97917 4.19583 3.45 4 4 4H16C16.55 4 17.0208 4.19583 17.4125 4.5875C17.8042 4.97917 18 5.45 18 6V10.5L21.15 7.35C21.3167 7.18333 21.5 7.14167 21.7 7.225C21.9 7.30833 22 7.46667 22 7.7V16.3C22 16.5333 21.9 16.6917 21.7 16.775C21.5 16.8583 21.3167 16.8167 21.15 16.65L18 13.5V18C18 18.55 17.8042 19.0208 17.4125 19.4125C17.0208 19.8042 16.55 20 16 20H4ZM4 18H16V6H4V18Z"),videocamOff:T("M18.0002 10.5L21.1502 7.35001C21.3169 7.18334 21.5002 7.14167 21.7002 7.22501C21.9002 7.30834 22.0002 7.46667 22.0002 7.70001V16.3C22.0002 16.5333 21.9002 16.6917 21.7002 16.775C21.5002 16.8583 21.3169 16.8167 21.1502 16.65L18.0002 13.5C18.0002 13.7833 17.9044 14.0208 17.7127 14.2125C17.521 14.4042 17.2835 14.5 17.0002 14.5C16.7169 14.5 16.4794 14.4042 16.2877 14.2125C16.096 14.0208 16.0002 13.7833 16.0002 13.5V6.00001H9.0002C8.66686 6.00001 8.41686 5.89584 8.2502 5.68751C8.08353 5.47917 8.0002 5.25001 8.0002 5.00001C8.0002 4.75001 8.08353 4.52084 8.2502 4.31251C8.41686 4.10417 8.66686 4.00001 9.0002 4.00001H16.0002C16.5502 4.00001 17.021 4.19584 17.4127 4.58751C17.8044 4.97917 18.0002 5.45001 18.0002 6.00001V10.5ZM19.8502 22.65L1.3502 4.15001C1.16686 3.96667 1.0752 3.73334 1.0752 3.45001C1.0752 3.16667 1.16686 2.93334 1.3502 2.75001C1.53353 2.56667 1.76686 2.47501 2.0502 2.47501C2.33353 2.47501 2.56686 2.56667 2.7502 2.75001L21.2502 21.25C21.4335 21.4333 21.5252 21.6667 21.5252 21.95C21.5252 22.2333 21.4335 22.4667 21.2502 22.65C21.0669 22.8333 20.8335 22.925 20.5502 22.925C20.2669 22.925 20.0335 22.8333 19.8502 22.65ZM4.0002 4.00001L6.0002 6.00001H4.0002V18H16.0002V16L18.0002 18C18.0002 18.55 17.8044 19.0208 17.4127 19.4125C17.021 19.8042 16.5502 20 16.0002 20H4.0002C3.4502 20 2.97936 19.8042 2.5877 19.4125C2.19603 19.0208 2.0002 18.55 2.0002 18V6.00001C2.0002 5.45001 2.19603 4.97917 2.5877 4.58751C2.97936 4.19584 3.4502 4.00001 4.0002 4.00001Z"),collapse:T("M9.92658 15H6.91499C6.63057 15 6.39215 14.9042 6.19974 14.7125C6.00734 14.5208 5.91113 14.2833 5.91113 14C5.91113 13.7167 6.00734 13.4792 6.19974 13.2875C6.39215 13.0958 6.63057 13 6.91499 13H10.9304C11.2149 13 11.4533 13.0958 11.6457 13.2875C11.8381 13.4792 11.9343 13.7167 11.9343 14V18C11.9343 18.2833 11.8381 18.5208 11.6457 18.7125C11.4533 18.9042 11.2149 19 10.9304 19C10.646 19 10.4076 18.9042 10.2152 18.7125C10.0228 18.5208 9.92658 18.2833 9.92658 18V15ZM15.9497 9H18.9613C19.2458 9 19.4842 9.09583 19.6766 9.2875C19.869 9.47917 19.9652 9.71667 19.9652 10C19.9652 10.2833 19.869 10.5208 19.6766 10.7125C19.4842 10.9042 19.2458 11 18.9613 11H14.9459C14.6615 11 14.423 10.9042 14.2306 10.7125C14.0382 10.5208 13.942 10.2833 13.942 10V6C13.942 5.71667 14.0382 5.47917 14.2306 5.2875C14.423 5.09583 14.6615 5 14.9459 5C15.2303 5 15.4687 5.09583 15.6611 5.2875C15.8535 5.47917 15.9497 5.71667 15.9497 6V9Z"),expand:T("M7 17H10C10.2833 17 10.5208 17.0958 10.7125 17.2875C10.9042 17.4792 11 17.7167 11 18C11 18.2833 10.9042 18.5208 10.7125 18.7125C10.5208 18.9042 10.2833 19 10 19H6C5.71667 19 5.47917 18.9042 5.2875 18.7125C5.09583 18.5208 5 18.2833 5 18V14C5 13.7167 5.09583 13.4792 5.2875 13.2875C5.47917 13.0958 5.71667 13 6 13C6.28333 13 6.52083 13.0958 6.7125 13.2875C6.90417 13.4792 7 13.7167 7 14V17ZM17 7H14C13.7167 7 13.4792 6.90417 13.2875 6.7125C13.0958 6.52083 13 6.28333 13 6C13 5.71667 13.0958 5.47917 13.2875 5.2875C13.4792 5.09583 13.7167 5 14 5H18C18.2833 5 18.5208 5.09583 18.7125 5.2875C18.9042 5.47917 19 5.71667 19 6V10C19 10.2833 18.9042 10.5208 18.7125 10.7125C18.5208 10.9042 18.2833 11 18 11C17.7167 11 17.4792 10.9042 17.2875 10.7125C17.0958 10.5208 17 10.2833 17 10V7Z")},tt='<svg viewBox="9.6 9.6 14 14" fill="none" aria-hidden="true" focusable="false"><path d="M9.40234 11.3525C8.91256 10.1281 10.1281 8.91256 11.3525 9.40234L22.6514 13.9219C23.9484 14.441 23.8937 16.2954 22.5684 16.7373L18.4326 18.1162C18.2833 18.166 18.166 18.2833 18.1162 18.4326L16.7373 22.5684C16.2954 23.8937 14.441 23.9484 13.9219 22.6514L9.40234 11.3525Z" fill="#111111" stroke="white"/></svg>';var et=[[0,1],[1,2],[2,3],[3,4],[0,5],[5,6],[6,7],[7,8],[9,10],[10,11],[11,12],[13,14],[14,15],[15,16],[0,17],[17,18],[18,19],[19,20],[5,9],[9,13],[13,17]];function it(r,t,e){let i=(r.x-t.x)*e,s=r.y-t.y;return Math.hypot(i,s)}function Mt(r,t=1){return Math.max(it(r[0],r[9],t),1e-4)}function st(r,t=1){return it(r[4],r[8],t)/Mt(r,t)}function rt(r){let t=r[4],e=r[8];return{x:(t.x+e.x)/2,y:(t.y+e.y)/2}}var D=3.2,Ft=1.6;function at(r,t,{pinching:e=!1}={}){let i=e?u.green:u.purple;r.lineCap="round",r.lineJoin="round",r.strokeStyle=i,r.lineWidth=Ft,r.beginPath();for(let[n,o]of et)r.moveTo(t[n].x,t[n].y),r.lineTo(t[o].x,t[o].y);r.stroke(),r.strokeStyle=u.green,r.lineWidth=1.4,r.setLineDash(e?[]:[3,3]),r.beginPath(),r.moveTo(t[8].x,t[8].y),r.lineTo(t[4].x,t[4].y),r.stroke(),r.setLineDash([]),r.fillStyle=i;let s=D/2;for(let n of t)r.fillRect(n.x-s,n.y-s,D,D)}var ht="data:image/png;base64,";var Y=class{constructor(t,e){this.options=t,this.handlers=e,this.state="idle",this.mini=!!t.minimized,this.root=document.createElement("div"),this.root.className="hc-root",this.root.dataset.position=t.position,this.root.dataset.state=this.state,this.root.dataset.mini=String(this.mini),this.root.innerHTML=`
      <div class="hc-panel" role="region" aria-label="Hand tracking trackpad">
        <div class="hc-stage">
          ...
          <div class="hc-illo"><img class="hc-illo-img" src="${ht}" alt="" width="${c.illoWidth}" height="${c.illoHeight}" draggable="false" /></div>
        </div>
        <p class="hc-copy"></p>
    ...
    `;let i=s=>this.root.querySelector(s);this.panel=i(".hc-panel"),this.video=i(".hc-video"),this.canvas=i(".hc-overlay"),this.copy=i(".hc-copy"),this.cta=i(".hc-cta"),this.cornerLeft=i(".hc-corner--tl"),this.cornerRight=i(".hc-corner--tr"),this.miniCta=i(".hc-mini-cta"),this.status=i(".hc-sr"),this.ctx=this.canvas.getContext("2d"),this.canvasSize={width:0,height:0,dpr:0},this.cornerLeft.innerHTML=y.videocamOff,this.cornerLeft.title=t.strings.disable,this.cornerLeft.setAttribute("aria-label",t.strings.disable),this.cta.addEventListener("click",s=>e.onToggleCamera(s)),this.miniCta.addEventListener("click",s=>e.onToggleCamera(s)),this.cornerLeft.addEventListener("click",()=>e.onStop()),this.cornerRight.addEventListener("click",()=>e.onToggleSize()),this.render()}mount(t){t.appendChild(this.root)}setState(t,e){this.state=t,this.root.dataset.state=t,this.message=e,this.render()}setMini(t){this.mini=t,this.root.dataset.mini=String(t),this.render()}render(){let t=this.options.strings,e=this.state==="loading",i=this.state==="live";this.copy.textContent=this.state==="error"?this.message||t.failed:t.intro;let s=e?t.starting:this.state==="error"?t.retry:t.enable;this.cta.innerHTML=(e?'<span class="hc-spinner"></span>':y.videocam)+`<span>${s}</span>`,this.cta.disabled=e,this.miniCta.innerHTML=i?y.videocamOff:y.videocam;let n=i?t.disable:t.enable;this.miniCta.title=n,this.miniCta.setAttribute("aria-label",n),this.miniCta.disabled=e;let o=this.mini?t.expand:t.minimize;this.cornerRight.innerHTML=this.mini?y.expand:y.collapse,this.cornerRight.title=o,this.cornerRight.setAttribute("aria-label",o),this.status.textContent=i?"Hand tracking is on.":this.state==="error"?this.message||t.failed:""}attachStream(t){return this.video.srcObject=t,this.video.play().catch(()=>{})}detachStream(){this.video.srcObject=null,this.clearOverlay()}syncCanvas(){let t=Math.min(window.devicePixelRatio||1,2),e=this.canvas.clientWidth,i=this.canvas.clientHeight;if(!e||!i)return null;let s=this.canvasSize;return(s.width!==e||s.height!==i||s.dpr!==t)&&(this.canvas.width=Math.round(e*t),this.canvas.height=Math.round(i*t),this.canvasSize={width:e,height:i,dpr:t}),{width:e,height:i,dpr:t}}clearOverlay(){this.canvas.width&&(this.ctx.setTransform(1,0,0,1,0,0),this.ctx.clearRect(0,0,this.canvas.width,this.canvas.height))}drawHand(t,e){let i=this.syncCanvas();if(!i)return;let{videoWidth:s,videoHeight:n}=this.video;if(this.ctx.setTransform(i.dpr,0,0,i.dpr,0,0),this.ctx.clearRect(0,0,i.width,i.height),!t||!s||!n)return;let o=Math.max(i.width/s,i.height/n),h=s*o,l=n*o,a=(i.width-h)/2,d=(i.height-l)/2,p=t.map(g=>({x:a+(1-g.x)*h,y:d+g.y*l}));at(this.ctx,p,{pinching:e})}destroy(){this.detachStream(),this.root.remove()}};var zt=(r,t,e)=>r<t?t:r>e?e:r,M=class{constructor(t){this.options=t,this.el=document.createElement("div"),this.el.className="hc-cursor",this.el.setAttribute("aria-hidden","true"),this.el.innerHTML=tt,this.x=0,this.y=0,this.angle=0,this.scale=t.cursor.scale,this.visible=!1,this.pressed=!1,this.lastMoveAt=0,this.reducedMotion=typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches}mount(t){t.appendChild(this.el)}setVisible(t){this.visible!==t&&(this.visible=t,this.el.dataset.visible=String(t))}setPressed(t){this.pressed=t}update(t,e,i,s,n){this.x=t,this.y=e;let o=this.options.rotation;if(o.enabled&&!this.reducedMotion){let l=Math.abs(i)<o.minSpeed?0:zt(i*o.gain,-o.maxAngle,o.maxAngle);this.angle+=(l-this.angle)*o.smoothing}else this.angle=0;let h=this.pressed?this.options.cursor.pressScale:this.options.cursor.scale;this.scale+=(h-this.scale)*.35,this.el.style.transform=`translate3d(${t.toFixed(2)}px, ${e.toFixed(2)}px, 0) rotate(${this.angle.toFixed(2)}deg) scale(${this.scale.toFixed(3)})`}reset(){this.angle=0,this.scale=this.options.cursor.scale,this.pressed=!1}destroy(){this.el.remove()}};function C(r,t,e){return{bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:r,clientY:t,screenX:(window.screenX||0)+r,screenY:(window.screenY||0)+t,...e}}var kt={pointerId:1,pointerType:"touch",isPrimary:!0,width:1,height:1};function m(r,t,e,i,s){r.dispatchEvent(new PointerEvent(t,C(e,i,{...kt,...s})))}function f(r,t,e,i,s){r.dispatchEvent(new MouseEvent(t,C(e,i,s)))}function v(r,t,e,i,s){return r.dispatchEvent(new DragEvent(t,C(e,i,{dataTransfer:s})))}var ct=/(auto|scroll|overlay)/;function lt(r){let t=getComputedStyle(r);return ct.test(t.overflowY)&&r.scrollHeight-r.clientHeight>1||ct.test(t.overflowX)&&r.scrollWidth-r.clientWidth>1}function Rt(r,t){let e=r;for(;e.parentElement;){let i=e.parentElement;if(getComputedStyle(i).cursor!==t)return e;if(i===document.body||i===document.documentElement)return null;e=i}return null}function z(r,t){let{selector:e,cursors:i,touchAction:s}=t,n=new Set(i),o=r;for(;o&&o.nodeType===1;){if(o.getAttribute?.("draggable")==="true")return{node:o,html5:!0};if(e&&o.matches?.(e))return{node:o,html5:!1};if(!(o===document.body||o===document.documentElement)&&!lt(o)){let a=getComputedStyle(o);if(n.has(a.cursor)){let d=Rt(o,a.cursor);if(d&&!lt(d))return{node:d,html5:!1}}if(s&&a.touchAction==="none")return{node:o,html5:!1}}o=o.parentElement||o.getRootNode()?.host||null}return null}var F=class{constructor(t,e,i,s,n){this.node=t.node,this.html5=t.html5&&n,this.started=!1,this.over=null,this.canDrop=!1,this.dataTransfer=null,this.pressed=e||this.node,m(this.pressed,"pointerdown",i,s,{buttons:1,button:0}),f(this.pressed,"mousedown",i,s,{buttons:1,button:0})}start(t,e){if(!this.started&&(this.started=!0,!!this.html5)){try{this.dataTransfer=new DataTransfer}catch{return}this.dataTransfer.effectAllowed="all",v(this.node,"dragstart",t,e,this.dataTransfer)}}move(t,e,i){let s=i||(this.pressed.isConnected?this.pressed:document);m(s,"pointermove",t,e,{buttons:1}),f(s,"mousemove",t,e,{buttons:1}),this.dataTransfer&&(v(this.node,"drag",t,e,this.dataTransfer),i!==this.over&&(this.over&&v(this.over,"dragleave",t,e,this.dataTransfer),i&&v(i,"dragenter",t,e,this.dataTransfer),this.over=i),this.canDrop=i?!v(i,"dragover",t,e,this.dataTransfer):!1)}clicks(t,e,i){if(i&&(this.pressed===i||this.pressed.contains(i)||i.contains(this.pressed)))return!0;let s=this.pressed.getBoundingClientRect?.();return!s||s.width===0&&s.height===0?!0:t>=s.left&&t<=s.right&&e>=s.top&&e<=s.bottom}end(t,e,i){let s=i||(this.pressed.isConnected?this.pressed:document);m(s,"pointerup",t,e,{buttons:0,button:0}),f(s,"mouseup",t,e,{buttons:0,button:0});let n=!!(this.dataTransfer&&this.over&&this.canDrop);return this.dataTransfer&&(n&&v(this.over,"drop",t,e,this.dataTransfer),v(this.node,"dragend",t,e,this.dataTransfer)),n}cancel(t,e){let i=this.pressed.isConnected?this.pressed:document;m(i,"pointercancel",t,e,{buttons:0}),this.dataTransfer&&(this.over&&v(this.over,"dragleave",t,e,this.dataTransfer),v(this.node,"dragend",t,e,this.dataTransfer))}};var dt=/(auto|scroll|overlay)/;function mt(r){let t=r;for(;t&&t!==document.documentElement&&t!==document.body;){if(t.nodeType===1){let i=getComputedStyle(t),s=dt.test(i.overflowY)&&t.scrollHeight-t.clientHeight>1,n=dt.test(i.overflowX)&&t.scrollWidth-t.clientWidth>1;if(s||n)return{node:t,canX:n,canY:s}}t=t.parentElement||t.getRootNode()?.host||null}let e=document.scrollingElement||document.documentElement;return{node:e,canX:e.scrollWidth-e.clientWidth>1,canY:e.scrollHeight-e.clientHeight>1}}function Ot(r){let t=r===document.scrollingElement?document.documentElement:r,e=t.style.scrollBehavior;return t.style.setProperty("scroll-behavior","auto","important"),()=>{e?t.style.setProperty("scroll-behavior",e,""):t.style.removeProperty("scroll-behavior")}}function Pt(r){let t=r===document.scrollingElement?document.documentElement:r;return getComputedStyle(t).scrollBehavior==="smooth"}function k(r){let t=window.devicePixelRatio||1;return Math.round(r*t)/t}function ut(r){return{x:Math.max(0,r.scrollWidth-r.clientWidth),y:Math.max(0,r.scrollHeight-r.clientHeight)}}function ft(r){return-1/(60*Math.log(r))}function pt(r,t,e){return r*ft(t)*e}var Lt=.05,Xt=.15,R=class{constructor(t,e){this.options=t,this.debug=e,this.target=null,this.askedX=0,this.askedY=0,this.appliedX=0,this.appliedY=0,this.path=[],this.interval=0,this.head=0,this.positionX=0,this.positionY=0,this.live=!1,this.velocityX=0,this.velocityY=0,this.flinging=!1,this.frame=null,this.lastFrameAt=0,this.restoreBehavior=null,this.lastRetargetAt=0,this.tick=this.tick.bind(this)}resetPath(){this.askedX=0,this.askedY=0,this.appliedX=0,this.appliedY=0,this.path=[],this.interval=0,this.head=0,this.live=!1}setTarget(t){t!==this.target&&(this.resetPath(),this.releaseBehavior()),this.target=t,t&&(this.claimPosition(),this.debug?.recordTarget(t.node,Pt(t.node)),this.debug?.beginTrace(t.node),this.lastRetargetAt=0,(this.options.drag.mode==="write"||this.options.drag.mode==="hybrid")&&(this.restoreBehavior||(this.restoreBehavior=Ot(t.node))))}releaseBehavior(){this.restoreBehavior?.(),this.restoreBehavior=null}claimPosition(){this.target&&(this.positionX=this.target.node.scrollLeft,this.positionY=this.target.node.scrollTop)}applyScroll(t,e){let{node:i,canX:s,canY:n}=this.target,o=ut(i);n&&(this.positionY=Math.max(0,Math.min(o.y,this.positionY-e))),s&&(this.positionX=Math.max(0,Math.min(o.x,this.positionX-t)));let h=k(this.positionY),l=k(this.positionX);try{i.scrollTo({top:h,left:l,behavior:"instant"})}catch{i.scrollTop=h,i.scrollLeft=l}this.debug&&this.debug.recordCommit(h,n?i.scrollTop:i.scrollLeft)}push(t,e,i){if(!this.target)return;this.flinging=!1,this.live=!0;let s=this.path.at(-1);if(s){let n=i-s.t;n>=8&&n<=250&&(this.interval=this.interval?this.interval*.7+n*.3:n)}if(this.path.length===0){let n=this.options.drag.resampleMax;this.path.push({t:i-n,x:this.askedX,y:this.askedY})}for(this.askedX+=t,this.askedY+=e,this.path.push({t:i,x:this.askedX,y:this.askedY});this.path.length>2&&i-this.path[0].t>1e3;)this.path.shift();this.options.drag.mode==="native"?this.retarget():this.start()}delay(){let{resample:t,resampleMin:e,resampleMax:i}=this.options.drag;return this.interval?Math.max(e,Math.min(i,this.interval*t)):i}advanceHead(t,e){let i=t-this.delay();if(!this.head)return this.head=i,this.head;this.head+=e;let s=e*Lt,n=(i-this.head)*Xt;return this.head+=Math.max(-s,Math.min(s,n)),this.head}positionAt(t){let e=this.path;if(e.length===0)return{x:this.appliedX,y:this.appliedY};let i=e[0];if(t<=i.t)return{x:i.x,y:i.y};let s=e.at(-1);if(t>=s.t){let d=e.at(-2),p=d?s.t-d.t:0;if(!this.live||!d||p<=0)return{x:s.x,y:s.y};let g=Math.min(t-s.t,this.options.drag.resampleMax)/p;return{x:s.x+(s.x-d.x)*g,y:s.y+(s.y-d.y)*g}}let n=e.length-1;for(;n>0&&e[n-1].t>t;)n-=1;let o=e[n-1],h=e[n],l=h.t-o.t,a=l>0?(t-o.t)/l:1;return{x:o.x+(h.x-o.x)*a,y:o.y+(h.y-o.y)*a}}retarget(t=!1,e="smooth"){let i=performance.now(),{retargetMs:s}=this.options.drag;if(!t&&i-this.lastRetargetAt<s)return!0;this.lastRetargetAt=i;let{node:n,canX:o,canY:h}=this.target,l=ut(n);h&&(this.positionY=Math.max(0,Math.min(l.y,this.positionY-this.remainingY))),o&&(this.positionX=Math.max(0,Math.min(l.x,this.positionX-this.remainingX)));let a=k(this.positionY),d=k(this.positionX);try{n.scrollTo({top:a,left:d,behavior:e})}catch{return!1}return this.appliedX=this.askedX,this.appliedY=this.askedY,this.debug?.recordScroll(0),!0}fling(t,e){let{minVelocity:i,maxVelocity:s,mode:n,friction:o,flingScale:h}=this.options.drag,l=K=>Math.max(-s,Math.min(s,K)),a=l(t),d=l(e),p=Math.hypot(a,d)<i;if(this.live=!1,(n==="native"||n==="hybrid")&&(p||(this.askedX+=pt(a,o,h),this.askedY+=pt(d,o,h)),this.releaseBehavior(),this.retarget(!0,"smooth"))){this.stop();return}if(p)return;let g=ft(o);this.velocityX=a+this.remainingX/g,this.velocityY=d+this.remainingY/g,this.appliedX=this.askedX,this.appliedY=this.askedY,this.flinging=!0,this.start()}start(){this.frame===null&&(this.lastFrameAt=0,this.frame=requestAnimationFrame(this.tick))}stop(){this.frame!==null&&(cancelAnimationFrame(this.frame),this.frame=null),this.flinging=!1,this.resetPath(),this.velocityX=0,this.velocityY=0,this.releaseBehavior()}tick(t){if(this.frame=null,!this.target)return;let e=this.lastFrameAt?Math.min(t-this.lastFrameAt,50):1e3/60,i=e/1e3;this.lastFrameAt=t;let s=0,n=0;if(this.flinging){let{friction:h,minVelocity:l}=this.options.drag,a=h**(i*60);this.velocityX*=a,this.velocityY*=a,s=this.velocityX*i,n=this.velocityY*i,Math.hypot(this.velocityX,this.velocityY)<l&&(this.flinging=!1)}else if(this.options.drag.follow>=1)s=this.remainingX,n=this.remainingY,this.appliedX=this.askedX,this.appliedY=this.askedY;else{let h=this.positionAt(this.advanceHead(t,e));s=h.x-this.appliedX,n=h.y-this.appliedY,this.appliedX=h.x,this.appliedY=h.y}(s||n)&&(this.applyScroll(s,n),this.debug?.recordScroll(n||s));let o=Math.abs(this.remainingX)<.001&&Math.abs(this.remainingY)<.001;!this.flinging&&o?(this.releaseBehavior(),this.debug?.endTrace()):this.frame=requestAnimationFrame(this.tick)}get remainingX(){return this.askedX-this.appliedX}get remainingY(){return this.askedY-this.appliedY}};var Qt="a[href], button, input, select, textarea, summary, [tabindex]",Ht=1e3;function Gt(r,t){let e=document.elementFromPoint(r,t);for(;e?.shadowRoot;){let i=e.shadowRoot.elementFromPoint(r,t);if(!i||i===e)break;e=i}return e}var O=class{constructor(t,{ui:e,onTap:i,onGrab:s,hover:n,debug:o}={}){this.options=t,this.ui=e,this.onTap=i,this.onGrab=s,this.hoverStyles=n,this.hovered=null,this.pressing=!1,this.dragging=!1,this.origin=null,this.last=null,this.samples=[],this.scrollTarget=null,this.scrolled=!1,this.grabTarget=null,this.grab=null,this.debug=o,this.scroller=new R(t,o)}resolve(t,e){let i=Gt(t,e);return{el:i,internal:!!this.ui?.contains(i)}}move(t,e){let{el:i,internal:s}=this.resolve(t,e);if(this.ui?.hover(s?i:null,t,e),s||!i){this.leaveHovered(t,e);return}i!==this.hovered&&(this.leaveHovered(t,e),this.hovered=i,this.hoverStyles?.set(i),m(i,"pointerover",t,e,{buttons:this.pressing?1:0}),f(i,"mouseover",t,e,{buttons:this.pressing?1:0}),i.dispatchEvent(new MouseEvent("mouseenter",{...C(t,e),bubbles:!1,cancelable:!1}))),m(i,"pointermove",t,e,{buttons:this.pressing?1:0}),f(i,"mousemove",t,e,{buttons:this.pressing?1:0})}leaveHovered(t,e){let i=this.hovered;i&&(this.hovered=null,this.hoverStyles?.clear(),m(i,"pointerout",t,e,{buttons:0}),f(i,"mouseout",t,e,{buttons:0}),i.dispatchEvent(new MouseEvent("mouseleave",{...C(t,e),bubbles:!1,cancelable:!1})))}press(t,e,i){this.scroller.stop();let{el:s,internal:n}=this.resolve(t,e);this.pressing=!0,this.dragging=!1,this.origin={x:t,y:e,t:i,el:s,internal:n},this.last={x:t,y:e,t:i},this.samples=[{x:t,y:e,t:i}];let o=this.options.grab;this.grabTarget=o.enabled&&s&&!n?z(s,o):null,this.scrolled=!1;let h=!!this.grabTarget&&o.holdDelay===0;this.scrollTarget=n||!s||h?null:mt(s),this.scroller.setTarget(this.scrollTarget),h&&this.beginGrab(t,e,s)}pastDragGate(t,e,i,s){let{holdDelay:n,holdEscape:o}=this.options.drag,h=Math.hypot(t-this.origin.x,e-this.origin.y);return h<o&&i-this.origin.t<n?!1:h>=s}drag(t,e,i){if(!this.pressing)return;let s=t-this.last.x,n=e-this.last.y;this.last={x:t,y:e,t:i},this.samples.push({x:t,y:e,t:i});let o=this.options.drag.velocityWindow*2;for(;this.samples.length>2&&i-this.samples[0].t>o;)this.samples.shift();if(this.grab){!this.dragging&&i-this.origin.t>=this.options.grab.tapDuration&&(this.dragging=!0,this.grab.start(t,e)),this.dragElement(t,e);return}if(!this.dragging){if(!this.pastDragGate(t,e,i,this.options.drag.threshold))return;this.dragging=!0,this.leaveHovered(t,e)}if(this.grabTarget&&!this.scrolled&&i-this.origin.t>=this.options.grab.holdDelay){this.beginGrab(t,e,this.resolve(t,e).el),this.grab.start(t,e),this.dragElement(t,e);return}this.scrolled=!0,this.scroller.push(s,n,i)}beginGrab(t,e,i){this.scroller.stop(),this.scrollTarget=null,this.grab=new F(this.grabTarget,i,t,e,this.options.grab.html5),this.onGrab?.({type:"start",target:this.grab.node,x:t,y:e})}dragElement(t,e){let{el:i,internal:s}=this.resolve(t,e);this.grab.move(t,e,s?null:i)}releaseVelocity(){let t=this.samples.at(-1);if(!t)return{x:0,y:0};let e=t.t-this.options.drag.velocityWindow,i=this.samples.length-1;for(;i>0&&this.samples[i-1].t>=e;)i-=1;let s=this.samples[Math.max(i-1,0)],n=(t.t-s.t)/Ht;return n<=0?{x:0,y:0}:{x:(t.x-s.x)/n,y:(t.y-s.y)/n}}release(t,e,i){if(!this.pressing)return;let s=this.origin;if(this.pressing=!1,this.origin=null,this.grab){let n=this.grab,o=this.dragging||i-s.t>=this.options.grab.tapDuration;this.grab=null,this.grabTarget=null,this.dragging=!1;let{el:h,internal:l}=this.resolve(t,e),a=n.end(t,e,l?null:h);if(this.debug?.recordGesture({ms:i-s.t,travel:Math.hypot(t-s.x,e-s.y),verdict:o?"drag":"press"}),!o&&n.clicks(t,e,l?null:h)){let d=()=>this.click(n.pressed,s.x,s.y),{clickDelay:p}=this.options.grab;p>0?setTimeout(d,p):d()}this.onGrab?.({type:"end",target:n.node,dropped:a,x:t,y:e});return}if(this.grabTarget=null,this.dragging){this.dragging=!1;let n=this.releaseVelocity();this.scroller.fling(n.x,n.y);return}this.isTap(s,t,e,i)&&this.tap(s.x,s.y)}isTap(t,e,i,s){let{maxDuration:n,maxTravel:o}=this.options.tap;return Math.hypot(e-t.x,i-t.y)<=o&&s-t.t<=n}click(t,e,i){let s=t.closest?.(Qt);if(s)try{s.focus({preventScroll:!0})}catch{}else document.activeElement&&document.activeElement!==document.body&&document.activeElement.blur?.();f(t,"click",e,i,{buttons:0,button:0,detail:1}),this.onTap?.({x:e,y:i,target:t,internal:!1})}tap(t,e){let{el:i,internal:s}=this.resolve(t,e);if(i){if(s){this.ui.tap(i,t,e),this.onTap?.({x:t,y:e,target:i,internal:!0});return}m(i,"pointerdown",t,e,{buttons:1,button:0}),f(i,"mousedown",t,e,{buttons:1,button:0}),m(i,"pointerup",t,e,{buttons:0,button:0}),f(i,"mouseup",t,e,{buttons:0,button:0}),this.click(i,t,e)}}cancel(t=0,e=0){this.scroller.stop(),this.grab&&(this.grab.cancel(t,e),this.onGrab?.({type:"end",target:this.grab.node,dropped:!1,x:t,y:e}),this.grab=null),this.grabTarget=null,this.pressing=!1,this.dragging=!1,this.origin=null,this.scrollTarget=null,this.ui?.hover(null,t,e),this.leaveHovered(t,e)}destroy(){this.cancel()}};function gt(r,t){return 1/(1+1/(2*Math.PI*r)/t)}var P=class{constructor(){this.value=null}filter(t,e){return this.value=this.value===null?t:e*t+(1-e)*this.value,this.value}reset(){this.value=null}},L=class{constructor({minCutoff:t=1,beta:e=0,dCutoff:i=1}={}){this.minCutoff=t,this.beta=e,this.dCutoff=i,this.x=new P,this.dx=new P}filter(t,e){e>0||(e=1/60);let i=this.x.value,s=i===null?0:(t-i)/e,n=this.dx.filter(s,gt(this.dCutoff,e)),o=this.minCutoff+this.beta*Math.abs(n);return this.x.filter(t,gt(o,e))}reset(){this.x.reset(),this.dx.reset()}},I=class{constructor(t){this.fx=new L(t),this.fy=new L(t)}filter(t,e,i){return{x:this.fx.filter(t,i),y:this.fy.filter(e,i)}}reset(){this.fx.reset(),this.fy.reset()}};var X="data-hc-hover",Ut=r=>r.replace(/:hover\b/g,`[${X}]`);function Z(r,t){for(let e of r)if(e.selectorText)e.selectorText.includes(":hover")&&t.push(`${Ut(e.selectorText)}{${e.style.cssText}}`);else if(e.media){let i=[];Z(e.cssRules,i),i.length&&t.push(`@media ${e.conditionText}{${i.join("")}}`)}else if(e.conditionText&&e.cssRules){let i=[];Z(e.cssRules,i),i.length&&t.push(`@supports ${e.conditionText}{${i.join("")}}`)}}var Q=class{constructor(){this.style=null,this.chain=[],this.sheetCount=-1,this.warned=!1,this.observer=null}build(){let t=[],e=0;for(let i of document.styleSheets)if(i.ownerNode!==this.style)try{Z(i.cssRules,t)}catch{e+=1}e&&!this.warned&&(this.warned=!0,console.info(`[hand-cursor] ${e} cross-origin stylesheet(s) could not be read, so their :hover styles will not respond to the hand cursor.`)),this.style||(this.style=document.createElement("style"),this.style.setAttribute("data-hand-cursor-hover","")),this.style.textContent=t.join(`
`),document.head.appendChild(this.style),this.sheetCount=document.styleSheets.length,this.observer||this.watch()}watch(){let t=0;this.observer=new MutationObserver(()=>{document.styleSheets.length!==this.sheetCount&&(clearTimeout(t),t=setTimeout(()=>this.build(),250))}),this.observer.observe(document.documentElement,{childList:!0,subtree:!0})}set(t){if(this.chain[0]===t)return;let e=[];for(let i=t;i&&i.nodeType===1;i=i.parentElement)e.push(i);for(let i of this.chain)e.includes(i)||i.removeAttribute(X);for(let i of e)i.setAttribute(X,"");this.chain=e}clear(){for(let t of this.chain)t.removeAttribute(X);this.chain=[]}destroy(){this.clear(),this.observer?.disconnect(),this.observer=null,this.style?.remove(),this.style=null}};var vt=r=>r<0?0:r>1?1:r,H=class{constructor(t,{ui:e,onEvent:i,debug:s}={}){this.options=t,this.onEvent=i,this.debug=s,this.cursor=new M(t),this.hoverStyles=t.emulateHover?new Q:null,this.touch=new O(t,{ui:e,debug:s,hover:this.hoverStyles,onTap:n=>this.emit("tap",n),onGrab:({type:n,...o})=>this.emit(n==="start"?"grab":"drop",o)}),this.filter=new I(t.smoothing),this.position=null,this.velocity={x:0,y:0},this.pinching=!1,this.lastFrameAt=0}mount(t){this.cursor.mount(t)}emit(t,e){this.onEvent?.(t,e)}consume(t,e,i=1){this.debug?.recordTracked();let s=this.lastFrameAt?(e-this.lastFrameAt)/1e3:1/60;this.lastFrameAt=e;let n=rt(t),o=this.options.region,h=vt((1-n.x-o.x)/(1-2*o.x)),l=vt((n.y-o.y)/(1-2*o.y)),a=this.filter.filter(h*window.innerWidth,l*window.innerHeight,s),d=this.position;this.position=a,this.velocity=d?{x:a.x-d.x,y:a.y-d.y}:{x:0,y:0},this.cursor.setVisible(!0),this.cursor.update(a.x,a.y,this.velocity.x,this.velocity.y,e);let p=st(t,i),{on:g,off:K}=this.options.pinch,q=this.pinching?p<K:p<g;q&&!this.pinching?(this.pinching=!0,this.cursor.setPressed(!0),this.touch.press(a.x,a.y,e),this.emit("press",{x:a.x,y:a.y})):!q&&this.pinching&&(this.pinching=!1,this.cursor.setPressed(!1),this.touch.release(a.x,a.y,e),this.emit("release",{x:a.x,y:a.y})),this.pinching?this.touch.drag(a.x,a.y,e):this.touch.move(a.x,a.y);let J={x:a.x,y:a.y,pinching:this.pinching,ratio:p};return this.emit("move",J),J}release(){this.position?this.touch.cancel(this.position.x,this.position.y):this.touch.cancel(),this.pinching=!1,this.position=null,this.lastFrameAt=0,this.filter.reset(),this.cursor.setPressed(!1),this.cursor.setVisible(!1)}reset(){this.filter.reset(),this.cursor.reset(),this.lastFrameAt=0}setSmoothing(t){this.options.smoothing={...this.options.smoothing,...t},this.filter=new I(this.options.smoothing),this.lastFrameAt=0}prepareHoverStyles(){this.hoverStyles?.build()}destroy(){this.touch.destroy(),this.cursor.destroy(),this.hoverStyles?.destroy()}};var w=class{constructor(){this.values=[]}push(t){this.values.push(t),this.values.length>60&&this.values.shift()}get mean(){return this.values.length?this.values.reduce((t,e)=>t+e,0)/this.values.length:0}percentile(t){if(!this.values.length)return 0;let e=[...this.values].sort((i,s)=>i-s);return e[Math.min(e.length-1,Math.floor(e.length*t))]}get max(){return this.values.length?Math.max(...this.values):0}},jt=[["paint","repaints per second \u2014 the rate the screen can actually update"],["track","landmark frames per second"],["model","milliseconds per inference, mean / worst"],["frame","milliseconds between repaints, median / 95th"],["worst","longest gap between repaints"],["blocked","share of repaints later than 32ms"],["scroll","scroll writes per second, and mean step"],["commit","how far the browser\u2019s reported scroll offset trails what was just written, and how often it had not moved at all. Anything but 0 means this platform commits scrolls asynchronously"],["target","what is being scrolled, and whether its CSS asked for smooth"],["gesture","the last press: how long the pinch was actually held, how far the hand travelled, and what it was read as. The duration is the one to check against grab.tapDuration when presses are landing as drags"]],G=class{constructor(){this.inference=new w,this.frameGaps=new w,this.scrollSteps=new w,this.commitLag=new w,this.staleReads=0,this.commitReads=0,this.lastReported=null,this.paintCount=0,this.trackCount=0,this.scrollCount=0,this.blockedCount=0,this.lastPaintAt=0,this.lastReportAt=0,this.running=!1,this.targetLabel="",this.targetSmooth=!1,this.gestureLabel="",this.trace=[],this.traceNode=null,this.lastScrollTop=null,this.tracing=!1,this.el=document.createElement("div"),this.el.className="hc-debug",this.el.innerHTML=jt.map(([t,e])=>`<div class="hc-debug-row" title="${e}"><span>${t}</span><b data-k="${t}">\u2014</b></div>`).join("")+'<div class="hc-debug-trace"><span>per-frame scroll</span><code data-k="trace">drag the page to record</code></div>',this.tick=this.tick.bind(this)}mount(t){t.appendChild(this.el),this.start()}start(){this.running||(this.running=!0,this.lastPaintAt=0,this.lastReportAt=0,requestAnimationFrame(this.tick))}stop(){this.running=!1}recordInference(t){this.inference.push(t)}recordTracked(){this.trackCount+=1}recordScroll(t){this.scrollCount+=1,this.scrollSteps.push(Math.abs(t))}recordCommit(t,e){this.commitReads+=1,this.commitLag.push(Math.abs(t-e)),this.lastReported!==null&&e===this.lastReported&&(this.staleReads+=1),this.lastReported=e}beginTrace(t){this.traceNode=t,this.trace=[],this.lastScrollTop=null,this.tracing=!0}endTrace(){this.tracing=!1}recordGesture({ms:t,travel:e,verdict:i}){this.gestureLabel=`${Math.round(t)}ms ${Math.round(e)}px ${i}`}recordTarget(t,e){let i=t===document.scrollingElement||t===document.documentElement?"page":t.tagName.toLowerCase()+(t.id?`#${t.id}`:"");this.targetLabel=`${i} ${e?"SMOOTH":"auto"}`,this.targetSmooth=e}tick(t){if(!this.running)return;if(requestAnimationFrame(this.tick),this.lastPaintAt){let o=t-this.lastPaintAt;this.frameGaps.push(o),this.paintCount+=1,o>32&&(this.blockedCount+=1)}if(this.lastPaintAt=t,this.tracing&&this.traceNode){let o=this.traceNode.scrollTop;this.lastScrollTop!==null&&(this.trace.push(Math.round(o-this.lastScrollTop)),this.trace.length>240&&this.trace.shift()),this.lastScrollTop=o}this.lastReportAt||(this.lastReportAt=t);let e=t-this.lastReportAt;if(e<500)return;let i=o=>Math.round(o*1e3/e);this.set("paint",`${i(this.paintCount)}/s`),this.set("track",`${i(this.trackCount)}/s`),this.set("model",this.inference.values.length?`${this.inference.mean.toFixed(0)} / ${this.inference.max.toFixed(0)}ms`:"\u2014"),this.set("frame",`${this.frameGaps.percentile(.5).toFixed(0)} / ${this.frameGaps.percentile(.95).toFixed(0)}ms`),this.set("worst",`${this.frameGaps.max.toFixed(0)}ms`);let s=this.paintCount?this.blockedCount/this.paintCount*100:0;this.set("blocked",`${s.toFixed(0)}%`,s>20),this.set("scroll",this.scrollCount?`${i(this.scrollCount)}/s ${this.scrollSteps.mean.toFixed(1)}px`:"\u2014");let n=this.commitReads?this.staleReads/this.commitReads*100:0;if(this.set("commit",this.commitReads?`${this.commitLag.mean.toFixed(1)}px lag, ${n.toFixed(0)}% stale`:"\u2014",this.commitLag.mean>1),this.set("target",this.targetLabel||"\u2014",!!this.targetSmooth),this.set("gesture",this.gestureLabel||"\u2014"),this.trace.length){let o=this.trace.findIndex(a=>a!==0),h=o===-1?this.trace:this.trace.slice(o),l=this.el.querySelector('[data-k="trace"]');l&&(l.textContent=h.slice(-44).join(" "))}this.paintCount=0,this.trackCount=0,this.scrollCount=0,this.blockedCount=0,this.staleReads=0,this.commitReads=0,this.lastReportAt=t}set(t,e,i=!1){let s=this.el.querySelector(`[data-k="${t}"]`);s&&(s.textContent=e,s.classList.toggle("is-warn",i))}destroy(){this.stop(),this.el.remove()}};var U=null;function Kt(r){return U||(U=import(r).catch(e=>{throw U=null,e})),U}async function Bt({cdn:r,numHands:t,delegate:e}){let i=await Kt(r.vision),s=await i.FilesetResolver.forVisionTasks(r.wasm),n=o=>i.HandLandmarker.createFromOptions(s,{baseOptions:{modelAssetPath:r.model,delegate:o},runningMode:"VIDEO",numHands:t,minHandDetectionConfidence:.5,minHandPresenceConfidence:.5,minTrackingConfidence:.5});try{return await n(e)}catch(o){if(e==="CPU")throw o;return n("CPU")}}async function bt(r){try{return await Bt(r)}catch(t){throw console.error("[hand-cursor] could not load the MediaPipe model",t),Object.assign(t instanceof Error?t:new Error(String(t)),{code:"model"})}}async function xt({width:r,height:t,frameRate:e}){if(!window.isSecureContext)throw Object.assign(new Error("insecure context"),{code:"insecure"});if(!navigator.mediaDevices?.getUserMedia)throw Object.assign(new Error("getUserMedia unavailable"),{code:"missing"});let i;try{i=await navigator.mediaDevices.getUserMedia({audio:!1,video:{facingMode:"user",width:{ideal:r},height:{ideal:t},frameRate:{ideal:e}}})}catch(s){let n=s?.name==="NotAllowedError"||s?.name==="SecurityError"?"denied":s?.name==="NotFoundError"||s?.name==="OverconstrainedError"?"missing":"failed";throw Object.assign(s instanceof Error?s:new Error(String(s)),{code:n})}return i}function j(r){if(r)for(let t of r.getTracks())t.stop()}var Vt=400,S=class{constructor(t={}){this.options=W(E,t),this.host=document.createElement("div"),this.host.setAttribute("data-hand-cursor",""),this.shadow=this.host.attachShadow({mode:"open"});let e=document.createElement("style");e.textContent=_,this.shadow.appendChild(e),this.panel=new Y(this.options,{onToggleCamera:()=>this.running?this.stop():this.start(),onStop:()=>this.stop(),onToggleSize:()=>this.setMinimized(!this.panel.mini)}),this.panel.mount(this.shadow),this.debug=this.options.debug?new G:null,this.driver=new H(this.options,{ui:Wt(this.shadow),debug:this.debug,onEvent:(i,s)=>this.emit(i,s)}),this.driver.mount(this.panel.root),this.debug?.mount(this.panel.root),this.running=!1,this.starting=!1,this.destroyed=!1,this.stream=null,this.landmarker=null,this.frame=null,this.lastVideoTime=-1,this.lastHandAt=0,this.lastLandmarks=null,this.lastInferenceAt=0,this.applyStyleVariables(),this.onKeyDown=this.onKeyDown.bind(this),this.tick=this.tick.bind(this)}get position(){return this.driver.position}get pinching(){return this.driver.pinching}grabbableFrom(t){return t?z(t,this.options.grab):null}applyStyleVariables(){let{margin:t,zIndex:e,grayscale:i}=this.options;this.panel.root.style.setProperty("--hc-margin",`${t}px`),this.panel.root.style.setProperty("--hc-z",String(e)),this.panel.root.style.setProperty("--hc-video-filter",i?"grayscale(1)":"none")}mount(t=document.body){return this.mounted?this:(t.appendChild(this.host),this.mounted=!0,this.options.font&&this.injectFont(),document.addEventListener("keydown",this.onKeyDown,!0),this.options.autoStart&&this.start(),this)}injectFont(){if(document.fonts&&typeof document.fonts.check=="function"&&document.fonts.check("500 12px Inter")||document.querySelector('link[href*="family=Inter"]'))return;let e=document.createElement("link");e.rel="stylesheet",e.href=$,e.setAttribute("data-hand-cursor-font",""),document.head.appendChild(e)}onKeyDown(t){t.key==="Escape"&&this.running&&this.stop()}emit(t,e){document.dispatchEvent(new CustomEvent(`handcursor:${t}`,{detail:{...e,instance:this}}))}async start(){if(!(this.running||this.starting||this.destroyed)){this.starting=!0,this.panel.setState("loading");try{let[t,e]=await Promise.all([xt(this.options.camera),this.landmarker??bt({cdn:this.options.cdn,numHands:this.options.numHands??1,delegate:this.options.delegate})]);if(this.destroyed){j(t);return}this.stream=t,this.landmarker=e,await this.panel.attachStream(t),this.running=!0,this.starting=!1,this.lastVideoTime=-1,this.driver.reset(),this.driver.prepareHoverStyles(),this.panel.setState("live"),this.options.hideNativeCursor&&document.documentElement.style.setProperty("cursor","none","important"),this.frame=requestAnimationFrame(this.tick),this.emit("start",{})}catch(t){this.starting=!1,j(this.stream),this.stream=null;let e=this.options.strings,i=e[t?.code]||e.failed;this.panel.setState("error",i),this.emit("error",{error:t,message:i})}}}stop(){this.frame!==null&&(cancelAnimationFrame(this.frame),this.frame=null),j(this.stream),this.stream=null,this.running=!1,this.starting=!1,this.lastLandmarks=null,this.driver.release(),this.driver.reset(),this.panel.detachStream(),this.panel.setState("idle"),this.options.hideNativeCursor&&document.documentElement.style.removeProperty("cursor"),this.emit("stop",{})}setMinimized(t){this.panel.setMini(!!t),this.emit(t?"minimize":"expand",{})}destroy(){this.destroyed||(this.destroyed=!0,this.stop(),document.removeEventListener("keydown",this.onKeyDown,!0),this.landmarker?.close?.(),this.landmarker=null,this.debug?.destroy(),this.driver.destroy(),this.panel.destroy(),this.host.remove(),this.mounted=!1)}tick(t){if(!this.running)return;this.frame=requestAnimationFrame(this.tick);let e=this.panel.video;if(e.readyState<2||!e.videoWidth)return;let{maxTrackingFps:i}=this.options,s=i>0?this.lastInferenceAt+1e3/i:0;if(e.currentTime!==this.lastVideoTime&&t>=s){this.lastVideoTime=e.currentTime,this.lastInferenceAt=t;let n=this.debug?performance.now():0;try{let o=this.landmarker.detectForVideo(e,t);this.lastLandmarks=o?.landmarks?.[0]??null}catch{this.lastLandmarks=null}this.debug?.recordInference(performance.now()-n)}this.lastLandmarks?(this.lastHandAt=t,this.consumeHand(this.lastLandmarks,t,e)):t-this.lastHandAt>Vt&&this.releaseHand(),this.panel.drawHand(this.lastLandmarks,this.pinching)}consumeHand(t,e,i){return this.driver.consume(t,e,i.videoWidth/i.videoHeight)}releaseHand(){this.lastLandmarks=null,this.driver.release()}};function Wt(r){let t=null,e=i=>{t!==i&&(t?.classList.remove("hc-hover"),i?.classList.add("hc-hover"),t=i||null)};return{contains:i=>!!(i&&r.contains(i)),hover:i=>e(i?.closest?.("button")||null),tap:i=>{let s=i?.closest?.("button");s&&!s.disabled&&s.click()}}}var yt="1.0.0",x=null;function N(r={}){x?.destroy();let t=typeof location<"u"&&location.href.includes("handcursor-debug");return x=new S(t?{...r,debug:!0}:r),x.mount(r.container||document.body),x}function At(){return x}function Ct(){x?.destroy(),x=null}var Dt=new Set(["autoStart","minimized","grayscale","font","hideNativeCursor"]),Zt=new Set(["margin","zIndex","numHands"]);function Nt(r){if(!r)return{};let t={};for(let[e,i]of Object.entries(r.dataset))if(e!=="manual")if(e==="model"||e==="vision"||e==="wasm")t.cdn={...t.cdn,[e]:i};else if(Dt.has(e))t[e]=i!=="false";else if(Zt.has(e)){let s=Number(i);Number.isFinite(s)&&(t[e]=s)}else t[e]=i;return t}function qt(r){if(r?.dataset.manual!==void 0)return;let t=Nt(r),e=()=>{x||N(t)};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e,{once:!0}):e()}typeof document<"u"&&qt(document.currentScript);var Jt={init:N,instance:At,destroy:Ct,DEFAULTS:E,VERSION:yt};return Yt($t);})();
