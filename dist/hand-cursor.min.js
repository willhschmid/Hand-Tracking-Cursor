...
.hc-root[data-state="live"] { --hc-tab-h: ${p.liveHeight}px; }
...
.hc-dock {
  position: absolute;
  width: ${u.panelWidth}px;
  height: ${u.panelHeight}px;
...
.hc-root[data-mini="true"][data-position$="-left"] .hc-dock {
  transform: translateX(calc(-1 * (var(--hc-margin) + ${u.panelWidth}px)));
}

.hc-root[data-mini="true"][data-position$="-right"] .hc-dock {
  transform: translateX(calc(var(--hc-margin) + ${u.panelWidth}px));
}
...
.hc-stage {
  ...
  flex: 0 0 auto;
  width: ${u.illoWidth}px;
  height: ${u.illoHeight}px;
  display: flex;
  align-items: center;
...
.hc-cta {
  ...
  justify-content: center;
  gap: ${u.ctaGap}px;
  height: ${u.ctaHeight}px;
  padding: 0 ${u.ctaPadX}px;
...
.hc-cta svg { width: ${u.iconSize}px; height: ${u.iconSize}px; flex: none; }
...
.hc-corner {
  ...
  justify-content: center;
  cursor: pointer;
  width: ${u.cornerButton}px;
  height: ${u.cornerButton}px;
  border-radius: ${g.button}px;
  background: ${l.red};
  color: ${l.white};
...
.hc-corner svg { width: ${u.iconSize}px; height: ${u.iconSize}px; }
...
.hc-corner--tl { top: ${u.cornerInset}px; left: ${u.cornerInset}px; }
...
.hc-tab {
  ...
  padding: ${p.pad}px ${(p.width-p.iconWidth)/2}px;
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: center;
...
.hc-root[data-mini="true"] .hc-corner {
  visibility: hidden;
  transition: visibility 0s linear ${N}ms;
}
      ...
      <div class="hc-dock">
        ...
        <div class="hc-panel" role="region" aria-label="Hand tracking trackpad">
          <div class="hc-stage">
            ...
            <div class="hc-illo"><img class="hc-illo-img" src="${ft}" alt="" width="${u.illoWidth}" height="${u.illoHeight}" draggable="false" /></div>
          </div>
          <p class="hc-copy"></p>
