...
.hc-panel {
  position: absolute;
  pointer-events: auto;
  width: ${d.panelWidth}px;
  height: ${d.panelHeight}px;
  padding: ${d.pad}px;
  display: flex;
  flex-direction: column;
  align-items: center;
  justify-content: space-between;
  background: ${u.lightGray};
  border-radius: ${S.card}px;
  overflow: hidden;
  box-shadow:
    0 0 0 1px ${u.divider},
...
.hc-stage {
  ...
  flex: 0 0 auto;
  width: ${d.illoWidth}px;
  height: ${d.illoHeight}px;
  display: flex;
  align-items: center;
...
.hc-copy {
  ...
  max-width: 100%;
  text-align: center;
  font-size: ${x.body.size}px;
  font-weight: ${x.body.weight};
  line-height: ${x.body.leading}px;
  letter-spacing: -0.01em;
  color: ${u.textSecondary};
}

.hc-root[data-state="error"] .hc-copy { color: ${u.red}; }
...
.hc-cta {
  ...
  justify-content: center;
  gap: ${d.ctaGap}px;
  height: ${d.ctaHeight}px;
  padding: 0 ${d.ctaPadX}px;
  border-radius: ${S.button}px;
  background: ${u.green};
  color: ${u.white};
  font-family: inherit;
  font-size: ${x.label.size}px;
  font-weight: ${x.label.weight};
  line-height: ${x.label.leading}px;
  letter-spacing: -0.01em;
  cursor: pointer;
...
.hc-cta:hover,
.hc-cta.hc-hover { background: ${u.darkGreen}; }
.hc-cta:active { transform: scale(0.97); }
.hc-cta[disabled] { opacity: 0.7; cursor: default; }

.hc-cta svg { width: ${d.iconSize}px; height: ${d.iconSize}px; flex: none; }
...
.hc-corner {
  width: ${d.cornerButton}px;
  height: ${d.cornerButton}px;
  border-radius: ${S.button}px;
  transition: background-color 150ms linear;
}

.hc-corner svg { width: ${d.iconSize}px; height: ${d.iconSize}px; }
.hc-corner:hover,
.hc-corner.hc-hover { background: ${u.divider}; }

.hc-corner--tr { top: ${d.cornerInset}px; right: ${d.cornerInset}px; display: inline-flex; }
.hc-corner--tl { top: ${d.cornerInset}px; left: ${d.cornerInset}px; }
...
.hc-root[data-mini="true"][data-position$="-left"] .hc-panel {
  left: 0;
  border-radius: 0 ${f.radius}px ${f.radius}px 0;
}

.hc-root[data-mini="true"][data-position$="-right"] .hc-panel {
  right: 0;
  border-radius: ${f.radius}px 0 0 ${f.radius}px;
}
...
.hc-debug-row b.is-warn { color: ${u.yellow}; }
...
`;var M=r=>`<svg viewBox="0 0 24 24" fill="none" aria-hidden="true" focusable="false"><path d="${r}" fill="currentColor"/></svg>`,w={chevron:'<svg viewBox="0 0 16 48" fill="none" aria-hidden="true" focusable="false"><path d="M3.89864 6.12617C4.65749 5.79418 5.54205 6.13992 5.87422 6.89864L12.173 21.2961C12.7877 22.7013 12.7877 24.2991 12.173 25.7043L5.87422 40.1018C5.54205 40.8605 4.65748 41.2062 3.89864 40.8742C3.13992 40.542 2.79418 39.6575 3.12617 38.8986L9.425 24.5022C9.70433 23.8635 9.70433 23.1369 9.425 22.4982L3.12617 8.10176C2.79418 7.34291 3.13992 6.45834 3.89864 6.12617Z" fill="currentColor"/></svg>',videocam:M("M4 20C3.45 20 2.97917 19.8042 2.5875 19.4125C2.19583 19.0208 2 18.55 2 18V6C2 5.45 2.19583 4.97917 2.5875 4.5875C2.97917 4.19583 3.45 4 4 4H16C16.55 4 17.0208 4.19583 17.4125 4.5875C17.8042 4.97917 18 5.45 18 6V10.5L21.15 7.35C21.3167 7.18333 21.5 7.14167 21.7 7.225C21.9 7.30833 22 7.46667 22 7.7V16.3C22 16.5333 21.9 16.6917 21.7 16.775C21.5 16.8583 21.3167 16.8167 21.15 16.65L18 13.5V18C18 18.55 17.8042 19.0208 17.4125 19.4125C17.0208 19.8042 16.55 20 16 20H4ZM4 18H16V6H4V18Z"),videocamOff:M("M18.0002 10.5L21.1502 7.35001C21.3169 7.18334 21.5002 7.14167 21.7002 7.22501C21.9002 7.30834 22.0002 7.46667 22.0002 7.70001V16.3C22.0002 16.5333 21.9002 16.6917 21.7002 16.775C21.5002 16.8583 21.3169 16.8167 21.1502 16.65L18.0002 13.5C18.0002 13.7833 17.9044 14.0208 17.7127 14.2125C17.521 14.4042 17.2835 14.5 17.0002 14.5C16.7169 14.5 16.4794 14.4042 16.2877 14.2125C16.096 14.0208 16.0002 13.7833 16.0002 13.5V6.00001H9.0002C8.66686 6.00001 8.41686 5.89584 8.2502 5.68751C8.08353 5.47917 8.0002 5.25001 8.0002 5.00001C8.0002 4.75001 8.08353 4.52084 8.2502 4.31251C8.41686 4.10417 8.66686 4.00001 9.0002 4.00001H16.0002C16.5502 4.00001 17.021 4.19584 17.4127 4.58751C17.8044 4.97917 18.0002 5.45001 18.0002 6.00001V10.5ZM19.8502 22.65L1.3502 4.15001C1.16686 3.96667 1.0752 3.73334 1.0752 3.45001C1.0752 3.16667 1.16686 2.93334 1.3502 2.75001C1.53353 2.56667 1.76686 2.47501 2.0502 2.47501C2.33353 2.47501 2.56686 2.56667 2.7502 2.75001L21.2502 21.25C21.4335 21.4333 21.5252 21.6667 21.5252 21.95C21.5252 22.2333 21.4335 22.4667 21.2502 22.65C21.0669 22.8333 20.8335 22.925 20.5502 22.925C20.2669 22.925 20.0335 22.8333 19.8502 22.65ZM4.0002 4.00001L6.0002 6.00001H4.0002V18H16.0002V16L18.0002 18C18.0002 18.55 17.8044 19.0208 17.4127 19.4125C17.021 19.8042 16.5502 20 16.0002 20H4.0002C3.4502 20 2.97936 19.8042 2.5877 19.4125C2.19603 19.0208 2.0002 18.55 2.0002 18V6.00001C2.0002 5.45001 2.19603 4.97917 2.5877 4.58751C2.97936 4.19584 3.4502 4.00001 4.0002 4.00001Z"),collapse:M("M9.92658 15H6.91499C6.63057 15 6.39215 14.9042 6.19974 14.7125C6.00734 14.5208 5.91113 14.2833 5.91113 14C5.91113 13.7167 6.00734 13.4792 6.19974 13.2875C6.39215 13.0958 6.63057 13 6.91499 13H10.9304C11.2149 13 11.4533 13.0958 11.6457 13.2875C11.8381 13.4792 11.9343 13.7167 11.9343 14V18C11.9343 18.2833 11.8381 18.5208 11.6457 18.7125C11.4533 18.9042 11.2149 19 10.9304 19C10.646 19 10.4076 18.9042 10.2152 18.7125C10.0228 18.5208 9.92658 18.2833 9.92658 18V15ZM15.9497 9H18.9613C19.2458 9 19.4842 9.09583 19.6766 9.2875C19.869 9.47917 19.9652 9.71667 19.9652 10C19.9652 10.2833 19.869 10.5208 19.6766 10.7125C19.4842 10.9042 19.2458 11 18.9613 11H14.9459C14.6615 11 14.423 10.9042 14.2306 10.7125C14.0382 10.5208 13.942 10.2833 13.942 10V6C13.942 5.71667 14.0382 5.47917 14.2306 5.2875C14.423 5.09583 14.6615 5 14.9459 5C15.2303 5 15.4687 5.09583 15.6611 5.2875C15.8535 5.47917 15.9497 5.71667 15.9497 6V9Z"),expand:M("M7 17H10C10.2833 17 10.5208 17.0958 10.7125 17.2875C10.9042 17.4792 11 17.7167 11 18C11 18.2833 10.9042 18.5208 10.7125 18.7125C10.5208 18.9042 10.2833 19 10 19H6C5.71667 19 5.47917 18.9042 5.2875 18.7125C5.09583 18.5208 5 18.2833 5 18V14C5 13.7167 5.09583 13.4792 5.2875 13.2875C5.47917 13.0958 5.71667 13 6 13C6.28333 13 6.52083 13.0958 6.7125 13.2875C6.90417 13.4792 7 13.7167 7 14V17ZM17 7H14C13.7167 7 13.4792 6.90417 13.2875 6.7125C13.0958 6.52083 13 6.28333 13 6C13 5.71667 13.0958 5.47917 13.2875 5.2875C13.4792 5.09583 13.7167 5 14 5H18C18.2833 5 18.5208 5.09583 18.7125 5.2875C18.9042 5.47917 19 5.71667 19 6V10C19 10.2833 18.9042 10.5208 18.7125 10.7125C18.5208 10.9042 18.2833 11 18 11C17.7167 11 17.4792 10.9042 17.2875 10.7125C17.0958 10.5208 17 10.2833 17 10V7Z")},it='<svg viewBox="9.6 9.6 14 14" fill="none" aria-hidden="true" focusable="false"><path d="M9.40234 11.3525C8.91256 10.1281 10.1281 8.91256 11.3525 9.40234L22.6514 13.9219C23.9484 14.441 23.8937 16.2954 22.5684 16.7373L18.4326 18.1162C18.2833 18.166 18.166 18.2833 18.1162 18.4326L16.7373 22.5684C16.2954 23.8937 14.441 23.9484 13.9219 22.6514L9.40234 11.3525Z" fill="#111111" stroke="white"/></svg>';var st=[[0,1],[1,2],[2,3],[3,4],[0,5],[5,6],[6,7],[7,8],[9,10],[10,11],[11,12],[13,14],[14,15],[15,16],[0,17],[17,18],[18,19],[19,20],[5,9],[9,13],[13,17]];function rt(r,t,e){let i=(r.x-t.x)*e,s=r.y-t.y;return Math.hypot(i,s)}function kt(r,t=1){return Math.max(rt(r[0],r[9],t),1e-4)}function ot(r,t=1){return rt(r[4],r[8],t)/kt(r,t)}function nt(r){let t=r[4],e=r[8];return{x:(t.x+e.x)/2,y:(t.y+e.y)/2}}var N=3.2,zt=1.6;function ct(r,t,{pinching:e=!1}={}){let i=e?u.green:u.purple;r.lineCap="round",r.lineJoin="round",r.strokeStyle=i,r.lineWidth=zt,r.beginPath();for(let[o,n]of st)r.moveTo(t[o].x,t[o].y),r.lineTo(t[n].x,t[n].y);r.stroke(),r.strokeStyle=u.green,r.lineWidth=1.4,r.setLineDash(e?[]:[3,3]),r.beginPath(),r.moveTo(t[8].x,t[8].y),r.lineTo(t[4].x,t[4].y),r.stroke(),r.setLineDash([]),r.fillStyle=i;let s=N/2;for(let o of t)r.fillRect(o.x-s,o.y-s,N,N)}var lt="data:image/png;base64,";var F=class{constructor(t,e){this.options=t,this.handlers=e,this.state="idle",this.mini=!!t.minimized,this.root=document.createElement("div"),this.root.className="hc-root",this.root.dataset.position=t.position,this.root.dataset.state=this.state,this.root.dataset.mini=String(this.mini),this.root.innerHTML=`
      <div class="hc-panel" role="region" aria-label="Hand tracking trackpad">
        <div class="hc-stage">
          ...
          <div class="hc-illo"><img class="hc-illo-img" src="${lt}" alt="" width="${d.illoWidth}" height="${d.illoHeight}" draggable="false" /></div>
        </div>
        <p class="hc-copy"></p>
    ...
    `;let i=s=>this.root.querySelector(s);this.panel=i(".hc-panel"),this.video=i(".hc-video"),this.canvas=i(".hc-overlay"),this.copy=i(".hc-copy"),this.cta=i(".hc-cta"),this.cornerLeft=i(".hc-corner--tl"),this.cornerRight=i(".hc-corner--tr"),this.tab=i(".hc-tab"),this.status=i(".hc-sr"),this.ctx=this.canvas.getContext("2d"),this.canvasSize={width:0,height:0,dpr:0},this.cornerLeft.innerHTML=w.videocamOff,this.cornerLeft.title=t.strings.disable,this.cornerLeft.setAttribute("aria-label",t.strings.disable),this.cta.addEventListener("click",s=>e.onToggleCamera(s)),this.tab.addEventListener("click",()=>e.onToggleSize()),this.cornerLeft.addEventListener("click",()=>e.onStop()),this.cornerRight.addEventListener("click",()=>e.onToggleSize()),this.render()}mount(t){t.appendChild(this.root)}setState(t,e){this.state=t,this.root.dataset.state=t,this.message=e,this.render()}setMini(t){this.mini=t,this.root.dataset.mini=String(t),this.render()}render(){let t=this.options.strings,e=this.state==="loading",i=this.state==="live";this.copy.textContent=this.state==="error"?this.message||t.failed:t.intro;let s=e?t.starting:this.state==="error"?t.retry:t.enable;this.cta.innerHTML=(e?'<span class="hc-spinner"></span>':w.videocam)+`<span>${s}</span>`,this.cta.disabled=e,this.tab.title=t.expand,this.tab.setAttribute("aria-label",t.expand);let o=this.mini?t.expand:t.minimize;this.cornerRight.innerHTML=this.mini?w.expand:w.collapse,this.cornerRight.title=o,this.cornerRight.setAttribute("aria-label",o),this.status.textContent=i?"Hand tracking is on.":this.state==="error"?this.message||t.failed:""}attachStream(t){return this.video.srcObject=t,this.video.play().catch(()=>{})}detachStream(){this.video.srcObject=null,this.clearOverlay()}syncCanvas(){let t=Math.min(window.devicePixelRatio||1,2),e=this.canvas.clientWidth,i=this.canvas.clientHeight;if(!e||!i)return null;let s=this.canvasSize;return(s.width!==e||s.height!==i||s.dpr!==t)&&(this.canvas.width=Math.round(e*t),this.canvas.height=Math.round(i*t),this.canvasSize={width:e,height:i,dpr:t}),{width:e,height:i,dpr:t}}clearOverlay(){this.canvas.width&&(this.ctx.setTransform(1,0,0,1,0,0),this.ctx.clearRect(0,0,this.canvas.width,this.canvas.height))}drawHand(t,e){let i=this.syncCanvas();if(!i)return;let{videoWidth:s,videoHeight:o}=this.video;if(this.ctx.setTransform(i.dpr,0,0,i.dpr,0,0),this.ctx.clearRect(0,0,i.width,i.height),!t||!s||!o)return;let n=Math.max(i.width/s,i.height/o),h=s*n,c=o*n,a=(i.width-h)/2,l=(i.height-c)/2,p=t.map(v=>({x:a+(1-v.x)*h,y:l+v.y*c}));ct(this.ctx,p,{pinching:e})}destroy(){this.detachStream(),this.root.remove()}};var Rt=(r,t,e)=>r<t?t:r>e?e:r,k=class{constructor(t){this.options=t,this.el=document.createElement("div"),this.el.className="hc-cursor",this.el.setAttribute("aria-hidden","true"),this.el.innerHTML=it,this.x=0,this.y=0,this.angle=0,this.scale=t.cursor.scale,this.visible=!1,this.pressed=!1,this.lastMoveAt=0,this.reducedMotion=typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches}mount(t){t.appendChild(this.el)}setVisible(t){this.visible!==t&&(this.visible=t,this.el.dataset.visible=String(t))}setPressed(t){this.pressed=t}update(t,e,i,s,o){this.x=t,this.y=e;let n=this.options.rotation;if(n.enabled&&!this.reducedMotion){let c=Math.abs(i)<n.minSpeed?0:Rt(i*n.gain,-n.maxAngle,n.maxAngle);this.angle+=(c-this.angle)*n.smoothing}else this.angle=0;let h=this.pressed?this.options.cursor.pressScale:this.options.cursor.scale;this.scale+=(h-this.scale)*.35,this.el.style.transform=`translate3d(${t.toFixed(2)}px, ${e.toFixed(2)}px, 0) rotate(${this.angle.toFixed(2)}deg) scale(${this.scale.toFixed(3)})`}reset(){this.angle=0,this.scale=this.options.cursor.scale,this.pressed=!1}destroy(){this.el.remove()}};function C(r,t,e){return{bubbles:!0,cancelable:!0,composed:!0,view:window,clientX:r,clientY:t,screenX:(window.screenX||0)+r,screenY:(window.screenY||0)+t,...e}}var Ot={pointerId:1,pointerType:"touch",isPrimary:!0,width:1,height:1};function m(r,t,e,i,s){r.dispatchEvent(new PointerEvent(t,C(e,i,{...Ot,...s})))}function g(r,t,e,i,s){r.dispatchEvent(new MouseEvent(t,C(e,i,s)))}function b(r,t,e,i,s){return r.dispatchEvent(new DragEvent(t,C(e,i,{dataTransfer:s})))}var dt=/(auto|scroll|overlay)/;function ut(r){let t=getComputedStyle(r);return dt.test(t.overflowY)&&r.scrollHeight-r.clientHeight>1||dt.test(t.overflowX)&&r.scrollWidth-r.clientWidth>1}function Lt(r,t){let e=r;for(;e.parentElement;){let i=e.parentElement;if(getComputedStyle(i).cursor!==t)return e;if(i===document.body||i===document.documentElement)return null;e=i}return null}function R(r,t){let{selector:e,cursors:i,touchAction:s}=t,o=new Set(i),n=r;for(;n&&n.nodeType===1;){if(n.getAttribute?.("draggable")==="true")return{node:n,html5:!0};if(e&&n.matches?.(e))return{node:n,html5:!1};if(!(n===document.body||n===document.documentElement)&&!ut(n)){let a=getComputedStyle(n);if(o.has(a.cursor)){let l=Lt(n,a.cursor);if(l&&!ut(l))return{node:l,html5:!1}}if(s&&a.touchAction==="none")return{node:n,html5:!1}}n=n.parentElement||n.getRootNode()?.host||null}return null}var z=class{constructor(t,e,i,s,o){this.node=t.node,this.html5=t.html5&&o,this.started=!1,this.over=null,this.canDrop=!1,this.dataTransfer=null,this.pressed=e||this.node,m(this.pressed,"pointerdown",i,s,{buttons:1,button:0}),g(this.pressed,"mousedown",i,s,{buttons:1,button:0})}start(t,e){if(!this.started&&(this.started=!0,!!this.html5)){try{this.dataTransfer=new DataTransfer}catch{return}this.dataTransfer.effectAllowed="all",b(this.node,"dragstart",t,e,this.dataTransfer)}}move(t,e,i){let s=i||(this.pressed.isConnected?this.pressed:document);m(s,"pointermove",t,e,{buttons:1}),g(s,"mousemove",t,e,{buttons:1}),this.dataTransfer&&(b(this.node,"drag",t,e,this.dataTransfer),i!==this.over&&(this.over&&b(this.over,"dragleave",t,e,this.dataTransfer),i&&b(i,"dragenter",t,e,this.dataTransfer),this.over=i),this.canDrop=i?!b(i,"dragover",t,e,this.dataTransfer):!1)}clicks(t,e,i){if(i&&(this.pressed===i||this.pressed.contains(i)||i.contains(this.pressed)))return!0;let s=this.pressed.getBoundingClientRect?.();return!s||s.width===0&&s.height===0?!0:t>=s.left&&t<=s.right&&e>=s.top&&e<=s.bottom}end(t,e,i){let s=i||(this.pressed.isConnected?this.pressed:document);m(s,"pointerup",t,e,{buttons:0,button:0}),g(s,"mouseup",t,e,{buttons:0,button:0});let o=!!(this.dataTransfer&&this.over&&this.canDrop);return this.dataTransfer&&(o&&b(this.over,"drop",t,e,this.dataTransfer),b(this.node,"dragend",t,e,this.dataTransfer)),o}cancel(t,e){let i=this.pressed.isConnected?this.pressed:document;m(i,"pointercancel",t,e,{buttons:0}),this.dataTransfer&&(this.over&&b(this.over,"dragleave",t,e,this.dataTransfer),b(this.node,"dragend",t,e,this.dataTransfer))}};var pt=/(auto|scroll|overlay)/;function gt(r){let t=r;for(;t&&t!==document.documentElement&&t!==document.body;){if(t.nodeType===1){let i=getComputedStyle(t),s=pt.test(i.overflowY)&&t.scrollHeight-t.clientHeight>1,o=pt.test(i.overflowX)&&t.scrollWidth-t.clientWidth>1;if(s||o)return{node:t,canX:o,canY:s}}t=t.parentElement||t.getRootNode()?.host||null}let e=document.scrollingElement||document.documentElement;return{node:e,canX:e.scrollWidth-e.clientWidth>1,canY:e.scrollHeight-e.clientHeight>1}}function Pt(r){let t=r===document.scrollingElement?document.documentElement:r,e=t.style.scrollBehavior;return t.style.setProperty("scroll-behavior","auto","important"),()=>{e?t.style.setProperty("scroll-behavior",e,""):t.style.removeProperty("scroll-behavior")}}function Xt(r){let t=r===document.scrollingElement?document.documentElement:r;return getComputedStyle(t).scrollBehavior==="smooth"}function O(r){let t=window.devicePixelRatio||1;return Math.round(r*t)/t}function ft(r){return{x:Math.max(0,r.scrollWidth-r.clientWidth),y:Math.max(0,r.scrollHeight-r.clientHeight)}}function vt(r){return-1/(60*Math.log(r))}function mt(r,t,e){return r*vt(t)*e}var Ht=.05,Qt=.15,L=class{constructor(t,e){this.options=t,this.debug=e,this.target=null,this.askedX=0,this.askedY=0,this.appliedX=0,this.appliedY=0,this.path=[],this.interval=0,this.head=0,this.positionX=0,this.positionY=0,this.live=!1,this.velocityX=0,this.velocityY=0,this.flinging=!1,this.frame=null,this.lastFrameAt=0,this.restoreBehavior=null,this.lastRetargetAt=0,this.tick=this.tick.bind(this)}resetPath(){this.askedX=0,this.askedY=0,this.appliedX=0,this.appliedY=0,this.path=[],this.interval=0,this.head=0,this.live=!1}setTarget(t){t!==this.target&&(this.resetPath(),this.releaseBehavior()),this.target=t,t&&(this.claimPosition(),this.debug?.recordTarget(t.node,Xt(t.node)),this.debug?.beginTrace(t.node),this.lastRetargetAt=0,(this.options.drag.mode==="write"||this.options.drag.mode==="hybrid")&&(this.restoreBehavior||(this.restoreBehavior=Pt(t.node))))}releaseBehavior(){this.restoreBehavior?.(),this.restoreBehavior=null}claimPosition(){this.target&&(this.positionX=this.target.node.scrollLeft,this.positionY=this.target.node.scrollTop)}applyScroll(t,e){let{node:i,canX:s,canY:o}=this.target,n=ft(i);o&&(this.positionY=Math.max(0,Math.min(n.y,this.positionY-e))),s&&(this.positionX=Math.max(0,Math.min(n.x,this.positionX-t)));let h=O(this.positionY),c=O(this.positionX);try{i.scrollTo({top:h,left:c,behavior:"instant"})}catch{i.scrollTop=h,i.scrollLeft=c}this.debug&&this.debug.recordCommit(h,o?i.scrollTop:i.scrollLeft)}push(t,e,i){if(!this.target)return;this.flinging=!1,this.live=!0;let s=this.path.at(-1);if(s){let o=i-s.t;o>=8&&o<=250&&(this.interval=this.interval?this.interval*.7+o*.3:o)}if(this.path.length===0){let o=this.options.drag.resampleMax;this.path.push({t:i-o,x:this.askedX,y:this.askedY})}for(this.askedX+=t,this.askedY+=e,this.path.push({t:i,x:this.askedX,y:this.askedY});this.path.length>2&&i-this.path[0].t>1e3;)this.path.shift();this.options.drag.mode==="native"?this.retarget():this.start()}delay(){let{resample:t,resampleMin:e,resampleMax:i}=this.options.drag;return this.interval?Math.max(e,Math.min(i,this.interval*t)):i}advanceHead(t,e){let i=t-this.delay();if(!this.head)return this.head=i,this.head;this.head+=e;let s=e*Ht,o=(i-this.head)*Qt;return this.head+=Math.max(-s,Math.min(s,o)),this.head}positionAt(t){let e=this.path;if(e.length===0)return{x:this.appliedX,y:this.appliedY};let i=e[0];if(t<=i.t)return{x:i.x,y:i.y};let s=e.at(-1);if(t>=s.t){let l=e.at(-2),p=l?s.t-l.t:0;if(!this.live||!l||p<=0)return{x:s.x,y:s.y};let v=Math.min(t-s.t,this.options.drag.resampleMax)/p;return{x:s.x+(s.x-l.x)*v,y:s.y+(s.y-l.y)*v}}let o=e.length-1;for(;o>0&&e[o-1].t>t;)o-=1;let n=e[o-1],h=e[o],c=h.t-n.t,a=c>0?(t-n.t)/c:1;return{x:n.x+(h.x-n.x)*a,y:n.y+(h.y-n.y)*a}}retarget(t=!1,e="smooth"){let i=performance.now(),{retargetMs:s}=this.options.drag;if(!t&&i-this.lastRetargetAt<s)return!0;this.lastRetargetAt=i;let{node:o,canX:n,canY:h}=this.target,c=ft(o);h&&(this.positionY=Math.max(0,Math.min(c.y,this.positionY-this.remainingY))),n&&(this.positionX=Math.max(0,Math.min(c.x,this.positionX-this.remainingX)));let a=O(this.positionY),l=O(this.positionX);try{o.scrollTo({top:a,left:l,behavior:e})}catch{return!1}return this.appliedX=this.askedX,this.appliedY=this.askedY,this.debug?.recordScroll(0),!0}fling(t,e){let{minVelocity:i,maxVelocity:s,mode:o,friction:n,flingScale:h}=this.options.drag,c=W=>Math.max(-s,Math.min(s,W)),a=c(t),l=c(e),p=Math.hypot(a,l)<i;if(this.live=!1,(o==="native"||o==="hybrid")&&(p||(this.askedX+=mt(a,n,h),this.askedY+=mt(l,n,h)),this.releaseBehavior(),this.retarget(!0,"smooth"))){this.stop();return}if(p)return;let v=vt(n);this.velocityX=a+this.remainingX/v,this.velocityY=l+this.remainingY/v,this.appliedX=this.askedX,this.appliedY=this.askedY,this.flinging=!0,this.start()}start(){this.frame===null&&(this.lastFrameAt=0,this.frame=requestAnimationFrame(this.tick))}stop(){this.frame!==null&&(cancelAnimationFrame(this.frame),this.frame=null),this.flinging=!1,this.resetPath(),this.velocityX=0,this.velocityY=0,this.releaseBehavior()}tick(t){if(this.frame=null,!this.target)return;let e=this.lastFrameAt?Math.min(t-this.lastFrameAt,50):1e3/60,i=e/1e3;this.lastFrameAt=t;let s=0,o=0;if(this.flinging){let{friction:h,minVelocity:c}=this.options.drag,a=h**(i*60);this.velocityX*=a,this.velocityY*=a,s=this.velocityX*i,o=this.velocityY*i,Math.hypot(this.velocityX,this.velocityY)<c&&(this.flinging=!1)}else if(this.options.drag.follow>=1)s=this.remainingX,o=this.remainingY,this.appliedX=this.askedX,this.appliedY=this.askedY;else{let h=this.positionAt(this.advanceHead(t,e));s=h.x-this.appliedX,o=h.y-this.appliedY,this.appliedX=h.x,this.appliedY=h.y}(s||o)&&(this.applyScroll(s,o),this.debug?.recordScroll(o||s));let n=Math.abs(this.remainingX)<.001&&Math.abs(this.remainingY)<.001;!this.flinging&&n?(this.releaseBehavior(),this.debug?.endTrace()):this.frame=requestAnimationFrame(this.tick)}get remainingX(){return this.askedX-this.appliedX}get remainingY(){return this.askedY-this.appliedY}};var Gt="a[href], button, input, select, textarea, summary, [tabindex]",Ut=1e3;function jt(r,t){let e=document.elementFromPoint(r,t);for(;e?.shadowRoot;){let i=e.shadowRoot.elementFromPoint(r,t);if(!i||i===e)break;e=i}return e}var P=class{constructor(t,{ui:e,onTap:i,onGrab:s,hover:o,debug:n}={}){this.options=t,this.ui=e,this.onTap=i,this.onGrab=s,this.hoverStyles=o,this.hovered=null,this.pressing=!1,this.dragging=!1,this.origin=null,this.last=null,this.samples=[],this.scrollTarget=null,this.scrolled=!1,this.grabTarget=null,this.grab=null,this.debug=n,this.scroller=new L(t,n)}resolve(t,e){let i=jt(t,e);return{el:i,internal:!!this.ui?.contains(i)}}move(t,e){let{el:i,internal:s}=this.resolve(t,e);if(this.ui?.hover(s?i:null,t,e),s||!i){this.leaveHovered(t,e);return}i!==this.hovered&&(this.leaveHovered(t,e),this.hovered=i,this.hoverStyles?.set(i),m(i,"pointerover",t,e,{buttons:this.pressing?1:0}),g(i,"mouseover",t,e,{buttons:this.pressing?1:0}),i.dispatchEvent(new MouseEvent("mouseenter",{...C(t,e),bubbles:!1,cancelable:!1}))),m(i,"pointermove",t,e,{buttons:this.pressing?1:0}),g(i,"mousemove",t,e,{buttons:this.pressing?1:0})}leaveHovered(t,e){let i=this.hovered;i&&(this.hovered=null,this.hoverStyles?.clear(),m(i,"pointerout",t,e,{buttons:0}),g(i,"mouseout",t,e,{buttons:0}),i.dispatchEvent(new MouseEvent("mouseleave",{...C(t,e),bubbles:!1,cancelable:!1})))}press(t,e,i){this.scroller.stop();let{el:s,internal:o}=this.resolve(t,e);this.pressing=!0,this.dragging=!1,this.origin={x:t,y:e,t:i,el:s,internal:o},this.last={x:t,y:e,t:i},this.samples=[{x:t,y:e,t:i}];let n=this.options.grab;this.grabTarget=n.enabled&&s&&!o?R(s,n):null,this.scrolled=!1;let h=!!this.grabTarget&&n.holdDelay===0;this.scrollTarget=o||!s||h?null:gt(s),this.scroller.setTarget(this.scrollTarget),h&&this.beginGrab(t,e,s)}pastDragGate(t,e,i,s){let{holdDelay:o,holdEscape:n}=this.options.drag,h=Math.hypot(t-this.origin.x,e-this.origin.y);return h<n&&i-this.origin.t<o?!1:h>=s}drag(t,e,i){if(!this.pressing)return;let s=t-this.last.x,o=e-this.last.y;this.last={x:t,y:e,t:i},this.samples.push({x:t,y:e,t:i});let n=this.options.drag.velocityWindow*2;for(;this.samples.length>2&&i-this.samples[0].t>n;)this.samples.shift();if(this.grab){!this.dragging&&i-this.origin.t>=this.options.grab.tapDuration&&(this.dragging=!0,this.grab.start(t,e)),this.dragElement(t,e);return}if(!this.dragging){if(!this.pastDragGate(t,e,i,this.options.drag.threshold))return;this.dragging=!0,this.leaveHovered(t,e)}if(this.grabTarget&&!this.scrolled&&i-this.origin.t>=this.options.grab.holdDelay){this.beginGrab(t,e,this.resolve(t,e).el),this.grab.start(t,e),this.dragElement(t,e);return}this.scrolled=!0,this.scroller.push(s,o,i)}beginGrab(t,e,i){this.scroller.stop(),this.scrollTarget=null,this.grab=new z(this.grabTarget,i,t,e,this.options.grab.html5),this.onGrab?.({type:"start",target:this.grab.node,x:t,y:e})}dragElement(t,e){let{el:i,internal:s}=this.resolve(t,e);this.grab.move(t,e,s?null:i)}releaseVelocity(){let t=this.samples.at(-1);if(!t)return{x:0,y:0};let e=t.t-this.options.drag.velocityWindow,i=this.samples.length-1;for(;i>0&&this.samples[i-1].t>=e;)i-=1;let s=this.samples[Math.max(i-1,0)],o=(t.t-s.t)/Ut;return o<=0?{x:0,y:0}:{x:(t.x-s.x)/o,y:(t.y-s.y)/o}}release(t,e,i){if(!this.pressing)return;let s=this.origin;if(this.pressing=!1,this.origin=null,this.grab){let o=this.grab,n=this.dragging||i-s.t>=this.options.grab.tapDuration;this.grab=null,this.grabTarget=null,this.dragging=!1;let{el:h,internal:c}=this.resolve(t,e),a=o.end(t,e,c?null:h);if(this.debug?.recordGesture({ms:i-s.t,travel:Math.hypot(t-s.x,e-s.y),verdict:n?"drag":"press"}),!n&&o.clicks(t,e,c?null:h)){let l=()=>this.click(o.pressed,s.x,s.y),{clickDelay:p}=this.options.grab;p>0?setTimeout(l,p):l()}this.onGrab?.({type:"end",target:o.node,dropped:a,x:t,y:e});return}if(this.grabTarget=null,this.dragging){this.dragging=!1;let o=this.releaseVelocity();this.scroller.fling(o.x,o.y);return}this.isTap(s,t,e,i)&&this.tap(s.x,s.y)}isTap(t,e,i,s){let{maxDuration:o,maxTravel:n}=this.options.tap;return Math.hypot(e-t.x,i-t.y)<=n&&s-t.t<=o}click(t,e,i){let s=t.closest?.(Gt);if(s)try{s.focus({preventScroll:!0})}catch{}else document.activeElement&&document.activeElement!==document.body&&document.activeElement.blur?.();g(t,"click",e,i,{buttons:0,button:0,detail:1}),this.onTap?.({x:e,y:i,target:t,internal:!1})}tap(t,e){let{el:i,internal:s}=this.resolve(t,e);if(i){if(s){this.ui.tap(i,t,e),this.onTap?.({x:t,y:e,target:i,internal:!0});return}m(i,"pointerdown",t,e,{buttons:1,button:0}),g(i,"mousedown",t,e,{buttons:1,button:0}),m(i,"pointerup",t,e,{buttons:0,button:0}),g(i,"mouseup",t,e,{buttons:0,button:0}),this.click(i,t,e)}}cancel(t=0,e=0){this.scroller.stop(),this.grab&&(this.grab.cancel(t,e),this.onGrab?.({type:"end",target:this.grab.node,dropped:!1,x:t,y:e}),this.grab=null),this.grabTarget=null,this.pressing=!1,this.dragging=!1,this.origin=null,this.scrollTarget=null,this.ui?.hover(null,t,e),this.leaveHovered(t,e)}destroy(){this.cancel()}};function bt(r,t){return 1/(1+1/(2*Math.PI*r)/t)}var X=class{constructor(){this.value=null}filter(t,e){return this.value=this.value===null?t:e*t+(1-e)*this.value,this.value}reset(){this.value=null}},H=class{constructor({minCutoff:t=1,beta:e=0,dCutoff:i=1}={}){this.minCutoff=t,this.beta=e,this.dCutoff=i,this.x=new X,this.dx=new X}filter(t,e){e>0||(e=1/60);let i=this.x.value,s=i===null?0:(t-i)/e,o=this.dx.filter(s,bt(this.dCutoff,e)),n=this.minCutoff+this.beta*Math.abs(o);return this.x.filter(t,bt(n,e))}reset(){this.x.reset(),this.dx.reset()}},T=class{constructor(t){this.fx=new H(t),this.fy=new H(t)}filter(t,e,i){return{x:this.fx.filter(t,i),y:this.fy.filter(e,i)}}reset(){this.fx.reset(),this.fy.reset()}};var Q="data-hc-hover",Kt=r=>r.replace(/:hover\b/g,`[${Q}]`);function q(r,t){for(let e of r)if(e.selectorText)e.selectorText.includes(":hover")&&t.push(`${Kt(e.selectorText)}{${e.style.cssText}}`);else if(e.media){let i=[];q(e.cssRules,i),i.length&&t.push(`@media ${e.conditionText}{${i.join("")}}`)}else if(e.conditionText&&e.cssRules){let i=[];q(e.cssRules,i),i.length&&t.push(`@supports ${e.conditionText}{${i.join("")}}`)}}var G=class{constructor(){this.style=null,this.chain=[],this.sheetCount=-1,this.warned=!1,this.observer=null}build(){let t=[],e=0;for(let i of document.styleSheets)if(i.ownerNode!==this.style)try{q(i.cssRules,t)}catch{e+=1}e&&!this.warned&&(this.warned=!0,console.info(`[hand-cursor] ${e} cross-origin stylesheet(s) could not be read, so their :hover styles will not respond to the hand cursor.`)),this.style||(this.style=document.createElement("style"),this.style.setAttribute("data-hand-cursor-hover","")),this.style.textContent=t.join(`
`),document.head.appendChild(this.style),this.sheetCount=document.styleSheets.length,this.observer||this.watch()}watch(){let t=0;this.observer=new MutationObserver(()=>{document.styleSheets.length!==this.sheetCount&&(clearTimeout(t),t=setTimeout(()=>this.build(),250))}),this.observer.observe(document.documentElement,{childList:!0,subtree:!0})}set(t){if(this.chain[0]===t)return;let e=[];for(let i=t;i&&i.nodeType===1;i=i.parentElement)e.push(i);for(let i of this.chain)e.includes(i)||i.removeAttribute(Q);for(let i of e)i.setAttribute(Q,"");this.chain=e}clear(){for(let t of this.chain)t.removeAttribute(Q);this.chain=[]}destroy(){this.clear(),this.observer?.disconnect(),this.observer=null,this.style?.remove(),this.style=null}};var xt=r=>r<0?0:r>1?1:r,U=class{constructor(t,{ui:e,onEvent:i,debug:s}={}){this.options=t,this.onEvent=i,this.debug=s,this.cursor=new k(t),this.hoverStyles=t.emulateHover?new G:null,this.touch=new P(t,{ui:e,debug:s,hover:this.hoverStyles,onTap:o=>this.emit("tap",o),onGrab:({type:o,...n})=>this.emit(o==="start"?"grab":"drop",n)}),this.filter=new T(t.smoothing),this.position=null,this.velocity={x:0,y:0},this.pinching=!1,this.lastFrameAt=0}mount(t){this.cursor.mount(t)}emit(t,e){this.onEvent?.(t,e)}consume(t,e,i=1){this.debug?.recordTracked();let s=this.lastFrameAt?(e-this.lastFrameAt)/1e3:1/60;this.lastFrameAt=e;let o=nt(t),n=this.options.region,h=xt((1-o.x-n.x)/(1-2*n.x)),c=xt((o.y-n.y)/(1-2*n.y)),a=this.filter.filter(h*window.innerWidth,c*window.innerHeight,s),l=this.position;this.position=a,this.velocity=l?{x:a.x-l.x,y:a.y-l.y}:{x:0,y:0},this.cursor.setVisible(!0),this.cursor.update(a.x,a.y,this.velocity.x,this.velocity.y,e);let p=ot(t,i),{on:v,off:W}=this.options.pinch,$=this.pinching?p<W:p<v;$&&!this.pinching?(this.pinching=!0,this.cursor.setPressed(!0),this.touch.press(a.x,a.y,e),this.emit("press",{x:a.x,y:a.y})):!$&&this.pinching&&(this.pinching=!1,this.cursor.setPressed(!1),this.touch.release(a.x,a.y,e),this.emit("release",{x:a.x,y:a.y})),this.pinching?this.touch.drag(a.x,a.y,e):this.touch.move(a.x,a.y);let _={x:a.x,y:a.y,pinching:this.pinching,ratio:p};return this.emit("move",_),_}release(){this.position?this.touch.cancel(this.position.x,this.position.y):this.touch.cancel(),this.pinching=!1,this.position=null,this.lastFrameAt=0,this.filter.reset(),this.cursor.setPressed(!1),this.cursor.setVisible(!1)}reset(){this.filter.reset(),this.cursor.reset(),this.lastFrameAt=0}setSmoothing(t){this.options.smoothing={...this.options.smoothing,...t},this.filter=new T(this.options.smoothing),this.lastFrameAt=0}prepareHoverStyles(){this.hoverStyles?.build()}destroy(){this.touch.destroy(),this.cursor.destroy(),this.hoverStyles?.destroy()}};var E=class{constructor(){this.values=[]}push(t){this.values.push(t),this.values.length>60&&this.values.shift()}get mean(){return this.values.length?this.values.reduce((t,e)=>t+e,0)/this.values.length:0}percentile(t){if(!this.values.length)return 0;let e=[...this.values].sort((i,s)=>i-s);return e[Math.min(e.length-1,Math.floor(e.length*t))]}get max(){return this.values.length?Math.max(...this.values):0}},Bt=[["paint","repaints per second \u2014 the rate the screen can actually update"],["track","landmark frames per second"],["model","milliseconds per inference, mean / worst"],["frame","milliseconds between repaints, median / 95th"],["worst","longest gap between repaints"],["blocked","share of repaints later than 32ms"],["scroll","scroll writes per second, and mean step"],["commit","how far the browser\u2019s reported scroll offset trails what was just written, and how often it had not moved at all. Anything but 0 means this platform commits scrolls asynchronously"],["target","what is being scrolled, and whether its CSS asked for smooth"],["gesture","the last press: how long the pinch was actually held, how far the hand travelled, and what it was read as. The duration is the one to check against grab.tapDuration when presses are landing as drags"]],j=class{constructor(){this.inference=new E,this.frameGaps=new E,this.scrollSteps=new E,this.commitLag=new E,this.staleReads=0,this.commitReads=0,this.lastReported=null,this.paintCount=0,this.trackCount=0,this.scrollCount=0,this.blockedCount=0,this.lastPaintAt=0,this.lastReportAt=0,this.running=!1,this.targetLabel="",this.targetSmooth=!1,this.gestureLabel="",this.trace=[],this.traceNode=null,this.lastScrollTop=null,this.tracing=!1,this.el=document.createElement("div"),this.el.className="hc-debug",this.el.innerHTML=Bt.map(([t,e])=>`<div class="hc-debug-row" title="${e}"><span>${t}</span><b data-k="${t}">\u2014</b></div>`).join("")+'<div class="hc-debug-trace"><span>per-frame scroll</span><code data-k="trace">drag the page to record</code></div>',this.tick=this.tick.bind(this)}mount(t){t.appendChild(this.el),this.start()}start(){this.running||(this.running=!0,this.lastPaintAt=0,this.lastReportAt=0,requestAnimationFrame(this.tick))}stop(){this.running=!1}recordInference(t){this.inference.push(t)}recordTracked(){this.trackCount+=1}recordScroll(t){this.scrollCount+=1,this.scrollSteps.push(Math.abs(t))}recordCommit(t,e){this.commitReads+=1,this.commitLag.push(Math.abs(t-e)),this.lastReported!==null&&e===this.lastReported&&(this.staleReads+=1),this.lastReported=e}beginTrace(t){this.traceNode=t,this.trace=[],this.lastScrollTop=null,this.tracing=!0}endTrace(){this.tracing=!1}recordGesture({ms:t,travel:e,verdict:i}){this.gestureLabel=`${Math.round(t)}ms ${Math.round(e)}px ${i}`}recordTarget(t,e){let i=t===document.scrollingElement||t===document.documentElement?"page":t.tagName.toLowerCase()+(t.id?`#${t.id}`:"");this.targetLabel=`${i} ${e?"SMOOTH":"auto"}`,this.targetSmooth=e}tick(t){if(!this.running)return;if(requestAnimationFrame(this.tick),this.lastPaintAt){let n=t-this.lastPaintAt;this.frameGaps.push(n),this.paintCount+=1,n>32&&(this.blockedCount+=1)}if(this.lastPaintAt=t,this.tracing&&this.traceNode){let n=this.traceNode.scrollTop;this.lastScrollTop!==null&&(this.trace.push(Math.round(n-this.lastScrollTop)),this.trace.length>240&&this.trace.shift()),this.lastScrollTop=n}this.lastReportAt||(this.lastReportAt=t);let e=t-this.lastReportAt;if(e<500)return;let i=n=>Math.round(n*1e3/e);this.set("paint",`${i(this.paintCount)}/s`),this.set("track",`${i(this.trackCount)}/s`),this.set("model",this.inference.values.length?`${this.inference.mean.toFixed(0)} / ${this.inference.max.toFixed(0)}ms`:"\u2014"),this.set("frame",`${this.frameGaps.percentile(.5).toFixed(0)} / ${this.frameGaps.percentile(.95).toFixed(0)}ms`),this.set("worst",`${this.frameGaps.max.toFixed(0)}ms`);let s=this.paintCount?this.blockedCount/this.paintCount*100:0;this.set("blocked",`${s.toFixed(0)}%`,s>20),this.set("scroll",this.scrollCount?`${i(this.scrollCount)}/s ${this.scrollSteps.mean.toFixed(1)}px`:"\u2014");let o=this.commitReads?this.staleReads/this.commitReads*100:0;if(this.set("commit",this.commitReads?`${this.commitLag.mean.toFixed(1)}px lag, ${o.toFixed(0)}% stale`:"\u2014",this.commitLag.mean>1),this.set("target",this.targetLabel||"\u2014",!!this.targetSmooth),this.set("gesture",this.gestureLabel||"\u2014"),this.trace.length){let n=this.trace.findIndex(a=>a!==0),h=n===-1?this.trace:this.trace.slice(n),c=this.el.querySelector('[data-k="trace"]');c&&(c.textContent=h.slice(-44).join(" "))}this.paintCount=0,this.trackCount=0,this.scrollCount=0,this.blockedCount=0,this.staleReads=0,this.commitReads=0,this.lastReportAt=t}set(t,e,i=!1){let s=this.el.querySelector(`[data-k="${t}"]`);s&&(s.textContent=e,s.classList.toggle("is-warn",i))}destroy(){this.stop(),this.el.remove()}};var K=null;function Wt(r){return K||(K=import(r).catch(e=>{throw K=null,e})),K}async function Vt({cdn:r,numHands:t,delegate:e}){let i=await Wt(r.vision),s=await i.FilesetResolver.forVisionTasks(r.wasm),o=n=>i.HandLandmarker.createFromOptions(s,{baseOptions:{modelAssetPath:r.model,delegate:n},runningMode:"VIDEO",numHands:t,minHandDetectionConfidence:.5,minHandPresenceConfidence:.5,minTrackingConfidence:.5});try{return await o(e)}catch(n){if(e==="CPU")throw n;return o("CPU")}}async function yt(r){try{return await Vt(r)}catch(t){throw console.error("[hand-cursor] could not load the MediaPipe model",t),Object.assign(t instanceof Error?t:new Error(String(t)),{code:"model"})}}async function At({width:r,height:t,frameRate:e}){if(!window.isSecureContext)throw Object.assign(new Error("insecure context"),{code:"insecure"});if(!navigator.mediaDevices?.getUserMedia)throw Object.assign(new Error("getUserMedia unavailable"),{code:"missing"});let i;try{i=await navigator.mediaDevices.getUserMedia({audio:!1,video:{facingMode:"user",width:{ideal:r},height:{ideal:t},frameRate:{ideal:e}}})}catch(s){let o=s?.name==="NotAllowedError"||s?.name==="SecurityError"?"denied":s?.name==="NotFoundError"||s?.name==="OverconstrainedError"?"missing":"failed";throw Object.assign(s instanceof Error?s:new Error(String(s)),{code:o})}return i}function B(r){if(r)for(let t of r.getTracks())t.stop()}var Dt=400,Y=class{constructor(t={}){this.options=Z(I,t),this.host=document.createElement("div"),this.host.setAttribute("data-hand-cursor",""),this.shadow=this.host.attachShadow({mode:"open"});let e=document.createElement("style");e.textContent=et,this.shadow.appendChild(e),this.panel=new F(this.options,{onToggleCamera:()=>this.running?this.stop():this.start(),onStop:()=>this.stop(),onToggleSize:()=>this.setMinimized(!this.panel.mini)}),this.panel.mount(this.shadow),this.debug=this.options.debug?new j:null,this.driver=new U(this.options,{ui:Zt(this.shadow),debug:this.debug,onEvent:(i,s)=>this.emit(i,s)}),this.driver.mount(this.panel.root),this.debug?.mount(this.panel.root),this.running=!1,this.starting=!1,this.destroyed=!1,this.stream=null,this.landmarker=null,this.frame=null,this.lastVideoTime=-1,this.lastHandAt=0,this.lastLandmarks=null,this.lastInferenceAt=0,this.applyStyleVariables(),this.onKeyDown=this.onKeyDown.bind(this),this.tick=this.tick.bind(this)}get position(){return this.driver.position}get pinching(){return this.driver.pinching}grabbableFrom(t){return t?R(t,this.options.grab):null}applyStyleVariables(){let{margin:t,zIndex:e,grayscale:i}=this.options;this.panel.root.style.setProperty("--hc-margin",`${t}px`),this.panel.root.style.setProperty("--hc-z",String(e)),this.panel.root.style.setProperty("--hc-video-filter",i?"grayscale(1)":"none")}mount(t=document.body){return this.mounted?this:(t.appendChild(this.host),this.mounted=!0,this.options.font&&this.injectFont(),document.addEventListener("keydown",this.onKeyDown,!0),this.options.autoStart&&this.start(),this)}injectFont(){if(document.fonts&&typeof document.fonts.check=="function"&&document.fonts.check("500 12px Inter")||document.querySelector('link[href*="family=Inter"]'))return;let e=document.createElement("link");e.rel="stylesheet",e.href=tt,e.setAttribute("data-hand-cursor-font",""),document.head.appendChild(e)}onKeyDown(t){t.key==="Escape"&&this.running&&this.stop()}emit(t,e){document.dispatchEvent(new CustomEvent(`handcursor:${t}`,{detail:{...e,instance:this}}))}async start(){if(!(this.running||this.starting||this.destroyed)){this.starting=!0,this.panel.setState("loading");try{let[t,e]=await Promise.all([At(this.options.camera),this.landmarker??yt({cdn:this.options.cdn,numHands:this.options.numHands??1,delegate:this.options.delegate})]);if(this.destroyed){B(t);return}this.stream=t,this.landmarker=e,await this.panel.attachStream(t),this.running=!0,this.starting=!1,this.lastVideoTime=-1,this.driver.reset(),this.driver.prepareHoverStyles(),this.panel.setState("live"),this.options.hideNativeCursor&&document.documentElement.style.setProperty("cursor","none","important"),this.frame=requestAnimationFrame(this.tick),this.emit("start",{})}catch(t){this.starting=!1,B(this.stream),this.stream=null;let e=this.options.strings,i=e[t?.code]||e.failed;this.panel.setState("error",i),this.emit("error",{error:t,message:i})}}}stop(){this.frame!==null&&(cancelAnimationFrame(this.frame),this.frame=null),B(this.stream),this.stream=null,this.running=!1,this.starting=!1,this.lastLandmarks=null,this.driver.release(),this.driver.reset(),this.panel.detachStream(),this.panel.setState("idle"),this.options.hideNativeCursor&&document.documentElement.style.removeProperty("cursor"),this.emit("stop",{})}setMinimized(t){this.panel.setMini(!!t),this.emit(t?"minimize":"expand",{})}destroy(){this.destroyed||(this.destroyed=!0,this.stop(),document.removeEventListener("keydown",this.onKeyDown,!0),this.landmarker?.close?.(),this.landmarker=null,this.debug?.destroy(),this.driver.destroy(),this.panel.destroy(),this.host.remove(),this.mounted=!1)}tick(t){if(!this.running)return;this.frame=requestAnimationFrame(this.tick);let e=this.panel.video;if(e.readyState<2||!e.videoWidth)return;let{maxTrackingFps:i}=this.options,s=i>0?this.lastInferenceAt+1e3/i:0;if(e.currentTime!==this.lastVideoTime&&t>=s){this.lastVideoTime=e.currentTime,this.lastInferenceAt=t;let o=this.debug?performance.now():0;try{let n=this.landmarker.detectForVideo(e,t);this.lastLandmarks=n?.landmarks?.[0]??null}catch{this.lastLandmarks=null}this.debug?.recordInference(performance.now()-o)}this.lastLandmarks?(this.lastHandAt=t,this.consumeHand(this.lastLandmarks,t,e)):t-this.lastHandAt>Dt&&this.releaseHand(),this.panel.drawHand(this.lastLandmarks,this.pinching)}consumeHand(t,e,i){return this.driver.consume(t,e,i.videoWidth/i.videoHeight)}releaseHand(){this.lastLandmarks=null,this.driver.release()}};function Zt(r){let t=null,e=i=>{t!==i&&(t?.classList.remove("hc-hover"),i?.classList.add("hc-hover"),t=i||null)};return{contains:i=>!!(i&&r.contains(i)),hover:i=>e(i?.closest?.("button")||null),tap:i=>{let s=i?.closest?.("button");s&&!s.disabled&&s.click()}}}var wt="1.0.0",y=null;function J(r={}){y?.destroy();let t=typeof location<"u"&&location.href.includes("handcursor-debug");return y=new Y(t?{...r,debug:!0}:r),y.mount(r.container||document.body),y}function Ct(){return y}function Et(){y?.destroy(),y=null}var Nt=new Set(["autoStart","minimized","grayscale","font","hideNativeCursor"]),qt=new Set(["margin","zIndex","numHands"]);function Jt(r){if(!r)return{};let t={};for(let[e,i]of Object.entries(r.dataset))if(e!=="manual")if(e==="model"||e==="vision"||e==="wasm")t.cdn={...t.cdn,[e]:i};else if(Nt.has(e))t[e]=i!=="false";else if(qt.has(e)){let s=Number(i);Number.isFinite(s)&&(t[e]=s)}else t[e]=i;return t}function $t(r){if(r?.dataset.manual!==void 0)return;let t=Jt(r),e=()=>{y||J(t)};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",e,{once:!0}):e()}typeof document<"u"&&$t(document.currentScript);var _t={init:J,instance:Ct,destroy:Et,DEFAULTS:I,VERSION:wt};return Ft(te);})();
